...
export default defineConfig(({ mode }) => {
  ...
  build: {
    rollupOptions: {
      ...
      input: {
        ...
        previewDealership: path.resolve(__dirname, "preview-dealership.html"),
        previewMobileStore: path.resolve(__dirname, "preview-mobile-store.html"),
        previewTireShop: path.resolve(__dirname, "preview-tire-shop.html"),
  ...
  resolve: {
    alias: {
      ...
      "@template-dealership": path.resolve(__dirname, "./src/template-dealership"),
      "@template-mobile-store": path.resolve(__dirname, "./src/template-mobile-store"),
      "@template-tire-shop": path.resolve(__dirname, "./src/template-tire-shop"),
    },
