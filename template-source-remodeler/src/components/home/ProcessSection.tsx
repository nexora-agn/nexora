...
/** Horizontal process timeline — not remodeling's vertical sticky sidebar */
    ...
    <section className="rm-section-pad bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))]">
      <div className="container-custom container-inset">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <p className="font-sans-brand text-xs font-semibold uppercase tracking-[0.28em] text-[hsl(var(--secondary))] mb-3">
            Our Remodeling Process
          </p>
          <h2 className="font-display text-3xl sm:text-4xl">
            Six Steps From Consultation to Completion
          </h2>
          <p className="mt-4 text-[hsl(var(--primary-foreground)/0.8)] font-sans-brand leading-relaxed">
            A proven path for NJ kitchen, bath, basement, and exterior projects — clear communication at every milestone.
          </p>
        </div>
