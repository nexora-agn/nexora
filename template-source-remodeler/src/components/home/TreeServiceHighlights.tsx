...
const TREE_SERVICES = [
  { id: "tree-removal", title: "Tree Removal", image: REMODELER_IMAGES.treeRemoval },
  { id: "tree-trimming", title: "Trimming & Pruning", image: REMODELER_IMAGES.treeTrimming },
  { id: "stump-grinding", title: "Stump Grinding", image: REMODELER_IMAGES.stumpGrinding },
  { id: "emergency-tree-service", title: "24/7 Emergency", image: REMODELER_IMAGES.emergencyTree },
] as const;
