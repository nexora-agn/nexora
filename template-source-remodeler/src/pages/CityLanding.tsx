...
import { getSeoCity } from "@/data/seoCities";
import { REMODELER_IMAGES, SERVICES } from "@/data/siteData";
...
const CityLanding = () => {
  ...
  const heroImage = REMODELER_IMAGES[city.imageKey] ?? REMODELER_IMAGES.customHome;
