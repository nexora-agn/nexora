...
/**
 * Homepage service cards: always driven by the main `services` catalog so each
 * card links to a real `/services/:id` route (avoids stale `servicesRibbon` rows
 * with placeholder `#` links or ids that are not in the catalog).
 */
