...
import { FOOTER_QUICK_LINKS, OFFICE_HOURS } from "@template-restaurant/data/siteData";
    ...
    <footer className="bg-[hsl(var(--primary))] text-white">
      <div className="container-custom container-inset py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div>
            <h4 className="font-sans-brand text-xs font-medium uppercase tracking-[0.2em] text-[hsl(var(--secondary))] mb-5">Menu</h4>
          ...
          <div>
            <h4 className="font-sans-brand text-xs font-medium uppercase tracking-[0.2em] text-[hsl(var(--secondary))] mb-5">Restaurant</h4>
            <ul className="space-y-3">
            ...
            <h4 className="font-sans-brand text-xs font-medium uppercase tracking-[0.2em] text-[hsl(var(--secondary))] mb-3 mt-8">Hours</h4>
            <ul className="space-y-2">
              {OFFICE_HOURS.map(row => (
                <li key={row.days} className="text-xs text-white/60">
                  <span className="text-white/80">{row.days}</span> · {row.hours}
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-white/70 mb-4">Seasonal menus, wine events, and exclusive offers.</p>
