...
import { PROPERTY_CATEGORIES } from "@template-restaurant/data/siteData";
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
        {PROPERTY_CATEGORIES.map((cat, i) => {
          ...
          return (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-border group-hover:border-[hsl(var(--secondary))] group-hover:bg-[hsl(var(--rest-champagne-light))] transition-all">
