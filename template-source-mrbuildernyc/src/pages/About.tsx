...
const ERAS = [
  {
    ...
    year: "2013",
    label: "Founded",
    headline: "One crew, one truck, honest NYC roofing.",
    body:
      "MrBuilderNYC started replacing roofs across Queens and Brooklyn where the weather never really lets up. Every nail accounted for before we invoiced.",
  },
  {
    id: "scale",
    year: "2017",
    label: "Brownstones & co-ops",
    headline: "Pitched roofs led us to flat roofs and co-op boards.",
    body:
      "NYC co-op boards get picky fast. We standardized photo packets, parapet detailing, and manufacturer call sheets — the same playbook we still run on brownstones and walk-ups.",
  },
  {
    id: "field",
    year: "2021",
    label: "Five-borough model",
  ...
  },
  {
    ...
    year: "Today",
    label: "Built for NYC",
    headline: "New leads still come from roofs we did years ago.",
    body:
      "Crews are still walking ladders across all five boroughs. Warranty callbacks stay tracked. Nor'easter season still gets the same tarp protocol — tarp first, paperwork second.",
  },
];

const KPI_TILES = [
  { label: "Years in NYC", value: "12+" },
  { label: "Boroughs served", value: "5" },
...
const PULL_QUOTES = [
  ...
  {
    quote:
      "Every roof wrap ends with a clean site and a superintendent sign-off.",
    author: "Field Operations",
  },
  {
    quote:
      "If a nor'easter's coming, we'd rather tarp than ghost you.",
    author: "Service desk",
  },
];
