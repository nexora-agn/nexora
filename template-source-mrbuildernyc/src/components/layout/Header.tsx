...
const RoofLogoMark = () => (
  <span
    className="flex h-11 w-11 items-center justify-center rounded-md bg-secondary text-white shadow-lg shadow-secondary/30"
    aria-hidden
  >
    <svg viewBox="0 0 64 64" fill="none" className="h-7 w-7">
      ...
      <path
        ...
        fill="currentColor"
      />
      {/* NYC skyline silhouette beneath the roof */}
