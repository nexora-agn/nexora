  ...
  return (
    <Layout>
      ...
      <ElectricalPageHero
        ...
        body="Real feedback from Dallas–Fort Worth homeowners and business owners who chose MINHS for panel upgrades, EV chargers, emergency repairs, and commercial electrical work."
