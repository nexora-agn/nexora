...
import PaginationControls from "@template-minhs/components/layout/PaginationControls";
...
import { MINHS_IMAGES, PROJECTS_LATEST_PAGE_SIZE } from "@template-minhs/data/siteData";
import { clampPage, parsePageParam, slicePage, totalPages as totalPagesCount } from "@template-minhs/lib/pagination";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Shop gallery from ${COMPANY.name} — European auto repair, diagnostics, maintenance, and service bays in Brooklyn.`}
        />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-wide leading-tight">
              Our Brooklyn Shop in Action
            </h1>
            <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
              Oil changes, brake service, diagnostics, factory maintenance, and European luxury vehicles — real work from our service bays and technicians.
            </p>
          </div>
      ...
      <CTASection
        ...
        subtitle="Book an appointment or call our Brooklyn shop for transparent estimates on European vehicle repair."
      />
    </Layout>
  );
};
