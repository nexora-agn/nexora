...
/** Verified Unsplash IDs (HTTP 200) — automotive / workshop imagery only. */
export const MINHS_IMAGES = {
  ...
  diagnostic: u("1530046614490-89e6f776b83b", 900, 900),
  ...
  /** Per-service imagery (each service has a distinct photo) */
  oilChange: u("1487754180451-c456f719a1fc", 800, 600),
  brakeService: u("1593699199342-59b40e08f0ac", 800, 600),
  transmission: u("1517524206127-48bbd363f3d7", 800, 600),
  engineDiag: u("1771340012319-0b4fca008b54", 800, 600),
  preventiveMaintenance: u("1723099971299-3789db53604c", 800, 600),
  suspension: u("1645445522156-9ac06bc7a767", 800, 600),
  electricalDiagnostics: u("1530046614490-89e6f776b83b", 800, 600),
  generalRepairs: u("1643700973089-baa86a1ab9ee", 900, 1100),
  servicesPageHero: u("1675034743372-672c3c3f8377", 1920, 600),
  projectsPageHero: u("1727893294198-e85137574f5b", 1920, 600),
  galleryWrenches: u("1613206485381-b028e578e791", 800, 600),
  galleryEngine: u("1486262715619-67b85e0b08d3", 800, 600),
  galleryGarageRed: u("1727893119356-1702fe921cf9", 800, 600),
  galleryGarageBlack: u("1596986952526-3be237187071", 800, 600),
  galleryTireBay: u("1675034743126-0f250a5fee51", 800, 600),
  galleryTools: u("1530124566582-a618bc2615dc", 800, 600),
  /** @deprecated Use workshopTools — kept for legacy ServiceDetail references */
  smartHome: u("1530124566582-a618bc2615dc", 600, 400),
  /** @deprecated Use serviceAreasHero */
...
export const SERVICES = [
  ...
  { id: "preventive-maintenance", title: "Preventive Maintenance", icon: "Calendar", description: "Factory-scheduled maintenance that extends vehicle life.", image: MINHS_IMAGES.preventiveMaintenance },
  ...
  { id: "electrical-diagnostics", title: "Electrical Diagnostics", icon: "Zap", description: "Module programming, wiring faults, and sensor issues.", image: MINHS_IMAGES.electricalDiagnostics },
  ...
  { id: "general-repairs", title: "General Repairs", icon: "Hammer", description: "Comprehensive European and import repair under one roof.", image: MINHS_IMAGES.generalRepairs },
];

export const BEFORE_AFTER_PROJECTS = [
  { id: "oil-change-bay", title: "Synthetic Oil Service", location: "Brooklyn, NY", category: "Oil Service", serviceId: "oil-changes", beforeImage: MINHS_IMAGES.galleryWrenches, afterImage: MINHS_IMAGES.oilChange },
  { id: "brake-service", title: "Brake & Rotor Service", location: "Brooklyn, NY", category: "Brakes", serviceId: "brake-repair", beforeImage: MINHS_IMAGES.galleryTireBay, afterImage: MINHS_IMAGES.brakeService },
  { id: "transmission-work", title: "Transmission Service", location: "Brooklyn, NY", category: "Transmission", serviceId: "transmission-service", beforeImage: MINHS_IMAGES.galleryEngine, afterImage: MINHS_IMAGES.transmission },
  { id: "engine-diagnostics", title: "Engine Diagnostics", location: "Brooklyn, NY", category: "Diagnostics", serviceId: "engine-diagnostics", beforeImage: MINHS_IMAGES.galleryTools, afterImage: MINHS_IMAGES.engineDiag },
  { id: "lift-maintenance", title: "Vehicle on Lift", location: "Brooklyn, NY", category: "Maintenance", serviceId: "preventive-maintenance", beforeImage: MINHS_IMAGES.galleryGarageRed, afterImage: MINHS_IMAGES.preventiveMaintenance },
  { id: "bmw-factory-care", title: "BMW Factory Maintenance", location: "Brooklyn, NY", category: "BMW", serviceId: "factory-scheduled-maintenance", beforeImage: MINHS_IMAGES.heroLuxury, afterImage: MINHS_IMAGES.bmwDetail },
  { id: "mercedes-service", title: "Mercedes-Benz Service", location: "Brooklyn, NY", category: "Mercedes", serviceId: "factory-scheduled-maintenance", beforeImage: MINHS_IMAGES.bmwDetail, afterImage: MINHS_IMAGES.mercedesDetail },
  { id: "porsche-performance", title: "Porsche Performance", location: "Brooklyn, NY", category: "Porsche", serviceId: "performance-services", beforeImage: MINHS_IMAGES.galleryGarageBlack, afterImage: MINHS_IMAGES.porscheDetail },
  { id: "technician-work", title: "Technicians at Work", location: "Brooklyn, NY", category: "Technicians", serviceId: "general-repairs", beforeImage: MINHS_IMAGES.galleryTools, afterImage: MINHS_IMAGES.generalRepairs },
  { id: "shop-environment", title: "European Auto Shop", location: "Brooklyn, NY", category: "Shop", serviceId: "general-repairs", beforeImage: MINHS_IMAGES.aboutHero, afterImage: MINHS_IMAGES.shopFloor },
];
...
/** Secondary hero/detail imagery per service (distinct from card thumbnail where possible). */
export const SERVICE_SECTION_IMAGES: Record<string, string> = {
  "oil-changes": MINHS_IMAGES.galleryWrenches,
  "brake-repair": MINHS_IMAGES.galleryTireBay,
  "transmission-service": MINHS_IMAGES.galleryEngine,
  "engine-diagnostics": MINHS_IMAGES.galleryTools,
  "preventive-maintenance": MINHS_IMAGES.galleryGarageRed,
  "suspension-repair": MINHS_IMAGES.galleryGarageBlack,
  "electrical-diagnostics": MINHS_IMAGES.workshopTools,
  "factory-scheduled-maintenance": MINHS_IMAGES.mercedesDetail,
  "performance-services": MINHS_IMAGES.heroLuxury,
  "general-repairs": MINHS_IMAGES.shopFloor,
};
...
export const SERVICE_DEEP_DIVES = SERVICES.map(s => ({
  ...
  body: [
    s.description,
    "Factory-trained technicians, transparent estimates, and warranty-backed workmanship on every European vehicle we service.",
  ],
