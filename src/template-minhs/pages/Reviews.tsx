  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`See what Brooklyn European vehicle owners say about ${COMPANY.name} — factory-trained technicians, honest pricing, and dealer-alternative service.`}
        />
      </Helmet>
      ...
      <ElectricalPageHero
        ...
        title="Trusted Across Brooklyn"
        eyebrowAfter={`${siteTop.ratingValue} Stars · ${siteTop.ratingCount} ${siteTop.ratingLabel}`}
        body="Real feedback from BMW, Mercedes, Audi, Porsche, and Land Rover owners who chose MINHS for maintenance, diagnostics, brakes, and complex European repairs."
        image={MINHS_IMAGES.reviewsHero}
        imageAlt="Automotive technician at work in Brooklyn"
      />
      ...
      <CTASection
        title="Experience the MINHS difference"
