...
const Careers = () => {
  ...
  return (
    <Layout>
      ...
      <section className="bg-[hsl(var(--minhs-surface))] py-14 lg:py-20 border-b border-slate-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {activeTab.perks.map(({ icon: Icon, title, body }) => (
              <article
                key={title}
                className="rounded-lg bg-[hsl(var(--minhs-surface))] border border-slate-100 p-6 hover:border-[hsl(var(--secondary))]/50 hover:-translate-y-0.5 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-base md:text-lg text-white/85 leading-relaxed max-w-md">
              Every MINHS job site runs under lockout/tagout, arc-flash awareness, and NEC compliance. Every employee has stop-work authority. We publish these metrics because insurers and GCs ask for them.
            </p>
          </div>
            ...
            {OPENINGS.map(role => (
              <li key={role.id}>
                <a
                  ...
                  className="group grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 px-5 md:px-7 py-5 hover:bg-[hsl(var(--minhs-surface))] transition-colors items-center"
                >
