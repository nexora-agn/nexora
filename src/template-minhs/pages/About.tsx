...
import { ABOUT_HERO_BADGES, MINHS_IMAGES } from "@template-minhs/data/siteData";
  ...
  return (
    <Layout>
      ...
      <ElectricalPageHero
        ...
        title="Brooklyn's European Auto Specialists"
        eyebrowAfter="Family Owned · ASE Certified"
        body={`${COMPANY.name} was built on a simple promise: dealer-level expertise, transparent communication, and every vehicle treated with respect. We're Brooklyn's independent European repair shop — not a franchise, not a quick-lube chain.`}
        image={MINHS_IMAGES.aboutHero}
        imageAlt="Automotive repair shop in Brooklyn"
        badges={
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 rounded-sm overflow-hidden ring-1 ring-[hsl(var(--border))]">
            <img
              ...
              alt="ASE certified automotive technician"
