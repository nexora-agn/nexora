        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          <div className="lg:col-span-4 lg:sticky lg:top-28">
            ...
            <h2 className="mt-2 font-display text-3xl sm:text-4xl lg:text-[2.75rem] font-bold uppercase text-[hsl(var(--primary))] leading-tight">
              Why Choose
              <span className="block text-[hsl(var(--secondary))]">MINHS</span>
            </h2>
            <p className="mt-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
              Family ownership, factory-trained technicians, and transparent communication — the premium
              European service experience Brooklyn drivers deserve.
            </p>
          </div>
