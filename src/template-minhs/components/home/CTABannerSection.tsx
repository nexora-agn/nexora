...
import { CTA_SECTION } from "@template-minhs/data/siteData";
      ...
      <div className="container-custom text-center max-w-4xl mx-auto">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="minhs-btn-outline-on-dark w-full sm:w-auto font-display font-bold uppercase tracking-wider rounded-sm px-8"
          >
            <a href={phoneHref}>
