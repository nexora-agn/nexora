  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`See what Central NJ homeowners and businesses say about ${COMPANY.name} — master plumbers, quality work, and honest pricing.`}
        />
      </Helmet>
      ...
      <PlumbingPageHero
        ...
        body="Real feedback from Central New Jersey homeowners and business owners who chose ClearCurrent Plumbing for drains, water heaters, emergency repairs, and commercial plumbing work."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-white/75 mt-2 text-sm max-w-lg">
              Master plumbers, upfront pricing, and quality work across the Dallas metro.
            </p>
          </div>
          <Button
            asChild
      ...
      <CTASection
        title="Experience the ClearCurrent Plumbing difference"
