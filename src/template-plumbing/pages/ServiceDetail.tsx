  ...
  return (
    <>
      <PlumbingPageHero
        ...
        body="When the pipes burst or something smells wrong, you need a licensed master — not a handyman with a proper tools. ClearCurrent Plumbing rolls stocked trucks across Central NJ to isolate faults, make safe repairs, and stop the leak."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-white/80 leading-relaxed text-sm">
              Stay safe, shut off your water main if you can, and call ClearCurrent Plumbing. We&apos;ll triage urgency and dispatch a master plumber — usually within 2–4 hours across Central NJ.
            </p>
