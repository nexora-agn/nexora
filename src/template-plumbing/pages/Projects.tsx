...
import PaginationControls from "@template-plumbing/components/layout/PaginationControls";
...
import { PROJECTS_LATEST_PAGE_SIZE } from "@template-plumbing/data/siteData";
import { clampPage, parsePageParam, slicePage, totalPages as totalPagesCount } from "@template-plumbing/lib/pagination";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
              Panel upgrades, water heaters, whole-home rewires, and commercial fit-outs — NEC-compliant installs with master plumber oversight from start to finish.
            </p>
          </div>
