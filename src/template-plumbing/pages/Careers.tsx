        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-base md:text-lg text-white/85 leading-relaxed max-w-md">
              Every ClearCurrent Plumbing job site runs under proper safety protocols and code-compliant plumbing. Every employee has stop-work authority. We publish these metrics because insurers and GCs ask for them.
            </p>
          </div>
