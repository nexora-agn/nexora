...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[hsl(var(--primary))] text-white shadow-lg shadow-black/20">
              ...
              <>
                ...
                <div className="leading-none">
                  <span className="block font-display text-lg sm:text-xl font-bold uppercase tracking-wide text-white group-hover:text-[hsl(var(--secondary))] transition-colors">
                    {(COMPANY.name || "CLEARCURRENT PLUMBING").split(" ")[0]}
                  </span>
                  <span className="block text-[10px] sm:text-[11px] font-medium tracking-widest text-white/55 uppercase">
                    {(COMPANY.name || "CLEARCURRENT PLUMBING").split(" ").slice(1).join(" ") || "Plumbing"}
                  </span>
                </div>
              </>
            )}
              ...
              return (
                <div key={link.path} className="relative group">
                  ...
                  {isServices && services.length > 0 && (
                    ...
                    >
                      <div className="max-h-[min(70vh,400px)] overflow-y-auto rounded-sm border border-white/10 bg-[hsl(var(--flow-dark-panel))] py-2 shadow-xl">
                        <Link
                          to="/services"
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t border-white/10 bg-[hsl(var(--flow-dark-panel))]">
