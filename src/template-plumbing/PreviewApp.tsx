...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-plumbing/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-plumbing/contexts/SiteContentContext";
import { mergeSiteContentState } from "@/lib/drafts";
import ScrollToTop from "@template-plumbing/components/ScrollToTop";
import ChatbotWidget from "@template-plumbing/components/Chatbot/ChatbotWidget";
import Index from "@template-plumbing/pages/Index";
import NotFound from "@template-plumbing/pages/NotFound";
...
const About = lazy(() => import("@template-plumbing/pages/About"));
const Services = lazy(() => import("@template-plumbing/pages/Services"));
const ServiceDetail = lazy(() => import("@template-plumbing/pages/ServiceDetail"));
const Projects = lazy(() => import("@template-plumbing/pages/Projects"));
const ProjectDetail = lazy(() => import("@template-plumbing/pages/ProjectDetail"));
const Blog = lazy(() => import("@template-plumbing/pages/Blog"));
const BlogPost = lazy(() => import("@template-plumbing/pages/BlogPost"));
const Team = lazy(() => import("@template-plumbing/pages/Team"));
const Contact = lazy(() => import("@template-plumbing/pages/Contact"));
const FAQ = lazy(() => import("@template-plumbing/pages/FAQ"));
const Reviews = lazy(() => import("@template-plumbing/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-plumbing/pages/ServiceAreas"));
const Careers = lazy(() => import("@template-plumbing/pages/Careers"));
const Financing = lazy(() => import("@template-plumbing/pages/Financing"));
const CityLanding = lazy(() => import("@template-plumbing/pages/CityLanding"));
...
/** Chirps slug for ClearCurrent Plumbing — preview + /templates/plumber showcase. */
const PLUMBING_CHIRPS_SLUG = "plumber";
...
const TemplateShell = ({ basename, chirpsSlug }: { basename?: string; chirpsSlug?: string }) => (
  <TemplateRouterShell basename={basename}>
    ...
    <TemplateChirpsEmbed chirpsSlug={chirpsSlug ?? PLUMBING_CHIRPS_SLUG} />
  </TemplateRouterShell>
);
