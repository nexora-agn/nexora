...
import {
  ...
  AWARDS,
  BLOG_POSTS,
} from "@template-restaurant/data/siteData";
...
const STORAGE_KEY = "restaurant-site-content-v1";
...
export const SITE_CONTENT_DEFAULTS: SiteContentState = {
  ...
  sectionVisibility: {
    "home.hero": true,
    "home.reservation": true,
    "home.menuHighlights": true,
    "home.signatureDishes": true,
    "home.chefStory": true,
    "home.experience": true,
    "home.privateEvents": true,
