...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-restaurant/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-restaurant/contexts/SiteContentContext";
...
import ScrollToTop from "@template-restaurant/components/ScrollToTop";
import Index from "@template-restaurant/pages/Index";
import NotFound from "@template-restaurant/pages/NotFound";
import type { Draft } from "@/lib/supabase";

const SHOW_TEMPLATE_CHATBOT = false;

const About = lazy(() => import("@template-restaurant/pages/About"));
const Menu = lazy(() => import("@template-restaurant/pages/Menu"));
const Gallery = lazy(() => import("@template-restaurant/pages/Gallery"));
const PrivateEvents = lazy(() => import("@template-restaurant/pages/PrivateEvents"));
const Reservations = lazy(() => import("@template-restaurant/pages/Reservations"));
const ReservationSuccess = lazy(() => import("@template-restaurant/pages/ReservationSuccess"));
const ManageReservation = lazy(() => import("@template-restaurant/pages/ManageReservation"));
const GiftCards = lazy(() => import("@template-restaurant/pages/GiftCards"));
const Blog = lazy(() => import("@template-restaurant/pages/Blog"));
const BlogPost = lazy(() => import("@template-restaurant/pages/BlogPost"));
const Contact = lazy(() => import("@template-restaurant/pages/Contact"));
const FAQ = lazy(() => import("@template-restaurant/pages/FAQ"));
const Reviews = lazy(() => import("@template-restaurant/pages/Reviews"));
