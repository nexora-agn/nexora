...
const DISPATCH: DispatchEntry[] = [
  {
    ...
    detail: "Brownstone re-roof · copper valley install",
    time: "Active now",
  },
  {
    status: "Mobilizing",
    city: "Astoria, Queens",
    detail: "Flat-roof TPO recover · permit pulled",
    time: "Today",
  },
  {
    status: "Closing out",
    city: "Manhattan, NY",
    detail: "Designer shingle install · co-op final punch",
    time: "This week",
  },
  {
    status: "Pre-walk",
...
const NEIGHBORHOOD_CASES = [
  {
    ...
    note: "Co-op board signed off before shingles arrived.",
  },
  {
    zip: "10471",
    city: "Riverdale",
    project: "Historic single-family reroof",
    note: "Synthetic underlayment + copper valley details.",
  },
  {
    zip: "11106",
    city: "Astoria",
    project: "Walk-up flat-roof rows",
    note: "Phased tear-offs so neighbors kept rooftop access.",
  },
  {
    zip: "10003",
    city: "Manhattan",
    project: "Mixed-use TPO",
  ...
  },
  {
    zip: "10314",
    city: "Staten Island",
    project: "Single-family compound",
    note: "Main house + detached garage under one production calendar.",
  },
];
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${COMPANY.name} serves all five NYC boroughs — Manhattan, Brooklyn, Queens, Bronx, and Staten Island.`}
        />
      </Helmet>
        ...
        <div className="container-custom px-4 md:px-8 py-16 md:py-24 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <p className="mt-6 max-w-xl text-base md:text-lg text-white/85 leading-relaxed">
              ...
              neighborhood below is reachable from our NYC yard before traffic.
              That's how we keep the cadence promise.
            </p>
          </div>
          <div className="lg:col-span-5 grid grid-cols-3 gap-3">
            {[
              { v: "5", l: "Boroughs" },
              { v: "<60 min", l: "Max drive" },
              { v: "100%", l: "Staff crews" },
            ].map(s => (
              <div
                key={s.l}
