...
const REVIEWS: ReviewItem[] = [
  {
    ...
    date: "Jan 2026",
    body:
      "Three bids on our brownstone re-roof. MrBuilderNYC photographed every slope before quoting and walked us through code upgrades the adjuster actually approved.",
  ...
  },
  {
    ...
    date: "Dec 2025",
    body:
      "They tarped ahead of a nor'easter, then peeled it back so we could finish interior paint. Respectful crew — radios low, no parking drama.",
    project: "TPO flat-roof upgrade",
  },
  {
    id: "r3",
    author: "Hassan R.",
    ...
    date: "Nov 2025",
    body:
      "Leak after a windy week turned out to be lifted ridge cap. They fixed it without upselling an entire deck — unheard of honesty in NYC.",
  ...
  },
  {
    ...
    date: "Oct 2025",
    body:
      "Co-op board flagged drip edge spacing. Superintendent sent photos the same night and re-ran the detail before the inspector returned.",
    project: "Co-op reroof",
  },
  {
    id: "r5",
    author: "Edmund K.",
