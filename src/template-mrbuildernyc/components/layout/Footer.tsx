          ...
          <div className="lg:col-span-1">
            {logoUrl ? (
              ...
              <div className="flex items-center gap-2.5 mb-5">
                <span className="flex h-11 w-11 items-center justify-center rounded-md bg-secondary text-white shadow-sm">
                  <svg viewBox="0 0 64 64" fill="none" aria-hidden className="h-7 w-7">
                    <path
                      d="M4 30 L32 8 L60 30 L54 30 L54 34 L10 34 L10 30 Z"
                      fill="currentColor"
                    />
                    <rect x="14" y="38" width="6" height="18" fill="currentColor" />
                    <rect x="22" y="34" width="6" height="22" fill="currentColor" opacity="0.85" />
                    <rect x="30" y="42" width="6" height="14" fill="currentColor" />
                    <rect x="38" y="36" width="6" height="20" fill="currentColor" opacity="0.85" />
                    <rect x="46" y="40" width="6" height="16" fill="currentColor" />
                  </svg>
                </span>
            ...
            <p className="text-sm text-white/75 leading-relaxed mb-6">
              NYC's trusted roofing and exterior construction experts. Protecting
              homes across all five boroughs with quality craftsmanship.
            </p>
