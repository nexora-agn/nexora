...
import { getServiceIcon } from "@template-homebuilder/lib/serviceIcons";
...
const HomeHero = () => {
  ...
  const heroImage =
    heroFromContent || resolveServiceImage("custom-homes", HOME_BUILDER_IMAGES.heroHome);
      ...
      <div className="container-custom container-inset py-12 md:py-16 lg:py-20">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 order-1 lg:order-2">
            <div className="relative w-full aspect-[4/5] sm:aspect-[5/6] max-h-[560px] lg:max-h-none overflow-hidden">
              <img
                src={heroImage}
