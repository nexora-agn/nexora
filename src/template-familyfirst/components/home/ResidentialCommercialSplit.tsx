...
const ResidentialCommercialSplit = () => {
  ...
  const residentialImg = residentialSvc
    ? resolveServiceImage(residentialSvc.id, residentialSvc.image || PLUMBING_IMAGES.residentialSplit)
    : PLUMBING_IMAGES.residentialSplit;
  const commercialImg = commercialSvc
    ? resolveServiceImage(commercialSvc.id, commercialSvc.image || PLUMBING_IMAGES.commercialSplit)
    : PLUMBING_IMAGES.commercialSplit;
