import { ShieldCheck, BadgeCheck, Wrench, Award } from "lucide-react";
...
const TRUST_ITEMS = [
  ...
  { icon: Wrench, label: "Master Plumber", sub: "Expert crew" },
...
const TrustLicenseBar = () => {
  ...
  return (
    <section className="bg-[hsl(var(--background))] py-6 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-[hsl(var(--border))] border border-[hsl(var(--border))] bg-white rounded-lg overflow-hidden">
