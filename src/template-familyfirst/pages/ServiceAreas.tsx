...
import { SEO_CITIES } from "@template-familyfirst/data/seoCities";
  ...
  return (
    <Layout>
      ...
      <PlumbingPageHero
        ...
        body="Family First Plumbing dispatches licensed master plumbers throughout Central New Jersey — from emergency repairs and drain cleaning to water heaters, boilers, and leak detection."
        image={PLUMBING_IMAGES.van}
        imageAlt="Family First Plumbing service van"
      />
      ...
      <section className="bg-white py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 rounded-sm overflow-hidden min-h-[360px] ring-1 ring-border">
            <iframe
              title="Family First Plumbing service area map"
              src={mapEmbedUrl}
