...
import { FAQ_BY_CATEGORY, FAQ_TABS, FAQ_ITEMS as DEFAULT_FAQ_ITEMS, type FaqTabId } from "@template-familyfirst/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Answers about ${COMPANY.name} plumbing services, emergency dispatch, pricing, permits, and warranties across Central NJ.`}
        />
      </Helmet>
      ...
      <PlumbingPageHero
        ...
        body="Everything you need to know about our master plumbers, emergency service, drains, water heaters, and code-compliant work across Central New Jersey."
        image={PLUMBING_IMAGES.workerPlumber2}
