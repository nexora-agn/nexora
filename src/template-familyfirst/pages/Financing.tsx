...
import { FINANCING_CONTENT, PLUMBING_IMAGES } from "@template-familyfirst/data/siteData";
  ...
  return (
    <Layout>
      ...
      <PlumbingPageHero
        ...
        body={content.body}
        image={content.image || PLUMBING_IMAGES.financing}
        imageAlt="Homeowner reviewing plumbing financing options"
      />
