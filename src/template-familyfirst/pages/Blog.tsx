...
const Blog = () => {
  ...
  const titleBase = `Plumbing Blog | ${COMPANY.name}`;
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Plumbing tips, safety guides, and Central NJ homeowner advice from the ${COMPANY.name} master plumbers.`}
        />
      </Helmet>
      ...
      <PlumbingPageHero
        ...
        body="Honest plumbing advice from licensed master plumbers — drains, water heaters, surge protection, and safety tips for Central New Jersey homeowners."
        image={PLUMBING_IMAGES.blogHero}
        imageAlt="Plumbing blog"
      />
            ...
            <div className="grid lg:grid-cols-3 gap-12 lg:gap-14">
              ...
              <aside className="space-y-8 lg:pt-2">
                ...
                <div className="rounded-lg bg-[hsl(var(--primary))] p-6 text-white">
                  <h3 className="font-display font-bold text-lg mb-2">Need an plumber?</h3>
                  <p className="text-sm text-white/85 mb-5 leading-relaxed">
                    Free estimates from licensed master plumbers. Same-day service across Central NJ.
                  </p>
