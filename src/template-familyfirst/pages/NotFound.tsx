...
const QUICK_LINKS: Array<{ label: string; to: string; description: string }> = [
  { label: "Services", to: "/services", description: "Emergency plumbing, drains, water heaters, and full residential & commercial service." },
  { label: "Contact", to: "/contact", description: "Free estimates and convenient scheduling across Central New Jersey." },
  { label: "Emergency Service", to: "/services/emergency-plumbing", description: "24/7 dispatch for burst pipes, leaks, and backups." },
];
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`This page could not be found. Return to ${COMPANY.name} for plumbing services in Central New Jersey.`}
        />
      </Helmet>

      <section className="relative overflow-hidden ff-page-hero border-b border-border text-[hsl(var(--foreground))]">
        <div
          aria-hidden
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -right-40 -top-40 h-[520px] w-[520px] rounded-full bg-[hsl(var(--secondary))]/10 blur-3xl"
        />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-24 md:py-32">
          <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-[1.05] mb-6 text-[hsl(var(--primary))]">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl mb-8">
                ...
                24/7 for plumbing emergencies.
              </p>

              {location.pathname && location.pathname !== "/" ? (
                <div className="mb-10 inline-flex items-center gap-2 rounded-sm border border-border bg-white px-3 py-2 text-xs md:text-sm font-mono text-muted-foreground max-w-full shadow-sm">
                  <span className="text-[hsl(var(--secondary))]">URL</span>
                  <span className="truncate">{location.pathname}</span>
                  <span className="shrink-0 rounded-sm bg-[hsl(var(--secondary))]/15 px-1.5 py-0.5 text-[10px] font-bold tracking-wider text-[hsl(var(--secondary))]">
                    404
                  </span>
                </div>
              ) : null}
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="rounded-sm font-semibold px-8 border-[hsl(var(--primary))]/25 text-[hsl(var(--primary))] bg-white hover:bg-[hsl(var(--flow-surface))]"
                >
                  <Link to="/services/emergency-plumbing" aria-label="Emergency plumbing service">
