...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-familyfirst/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-familyfirst/contexts/SiteContentContext";
...
import ScrollToTop from "@template-familyfirst/components/ScrollToTop";
import ChatbotWidget from "@template-familyfirst/components/Chatbot/ChatbotWidget";
import Index from "@template-familyfirst/pages/Index";
...
const About = lazy(() => import("@template-familyfirst/pages/About"));
const Services = lazy(() => import("@template-familyfirst/pages/Services"));
const ServiceDetail = lazy(() => import("@template-familyfirst/pages/ServiceDetail"));
const Projects = lazy(() => import("@template-familyfirst/pages/Projects"));
const ProjectDetail = lazy(() => import("@template-familyfirst/pages/ProjectDetail"));
const Blog = lazy(() => import("@template-familyfirst/pages/Blog"));
const BlogPost = lazy(() => import("@template-familyfirst/pages/BlogPost"));
const Team = lazy(() => import("@template-familyfirst/pages/Team"));
const Contact = lazy(() => import("@template-familyfirst/pages/Contact"));
const FAQ = lazy(() => import("@template-familyfirst/pages/FAQ"));
const Reviews = lazy(() => import("@template-familyfirst/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-familyfirst/pages/ServiceAreas"));
const Careers = lazy(() => import("@template-familyfirst/pages/Careers"));
const Financing = lazy(() => import("@template-familyfirst/pages/Financing"));
const CityLanding = lazy(() => import("@template-familyfirst/pages/CityLanding"));
...
/** Chirps slug for Family First Plumbing — preview + /templates/familyfirst-plumber showcase. */
const FAMILYFIRST_CHIRPS_SLUG = "familyfirst-plumber";
...
const TemplateShell = ({ basename, chirpsSlug }: { basename?: string; chirpsSlug?: string }) => (
  <TemplateRouterShell basename={basename}>
    ...
    <TemplateChirpsEmbed chirpsSlug={chirpsSlug ?? FAMILYFIRST_CHIRPS_SLUG} />
  </TemplateRouterShell>
);
