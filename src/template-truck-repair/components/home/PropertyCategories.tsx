...
import { PROPERTY_CATEGORIES } from "@template-truck-repair/data/siteData";

const PropertyCategories = () => (
  <section className="luxury-section bg-white">
    <div className="container-custom container-inset">
      <div className="text-center max-w-2xl mx-auto mb-14">
        <p className="luxury-eyebrow mb-3">Explore by Type</p>
        <h2 className="luxury-heading">Property Categories</h2>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
        {PROPERTY_CATEGORIES.map((cat, i) => {
          ...
          return (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-4 flex items-center justify-center border border-border group-hover:border-[hsl(var(--secondary))] group-hover:bg-[hsl(var(--truck-champagne-light))] transition-all">
