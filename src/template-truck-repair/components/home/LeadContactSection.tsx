...
const LeadContactSection = () => {
  ...
  return (
    <section id="estimate" className="hb-section-pad bg-[hsl(var(--hb-linen))]">
      <div className="container-custom container-inset">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[480px] overflow-hidden border-2 border-[hsl(var(--primary))]">
