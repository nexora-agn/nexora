...
import { HOME_BUILDER_IMAGES, SERVICE_AREA_COUNTIES } from "@template-dealership/data/siteData";
import { SEO_CITIES } from "@template-dealership/data/seoCities";
...
import { SERVICE_AREAS } from "@template-dealership/data/siteData";
