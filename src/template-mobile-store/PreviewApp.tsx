...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-mobile-store/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-mobile-store/contexts/SiteContentContext";
...
import ScrollToTop from "@template-mobile-store/components/ScrollToTop";
import Index from "@template-mobile-store/pages/Index";
import NotFound from "@template-mobile-store/pages/NotFound";
import type { Draft } from "@/lib/supabase";

const SHOW_TEMPLATE_CHATBOT = false;

const About = lazy(() => import("@template-mobile-store/pages/About"));
const Services = lazy(() => import("@template-mobile-store/pages/Services"));
const ServiceDetail = lazy(() => import("@template-mobile-store/pages/ServiceDetail"));
const Listings = lazy(() => import("@template-mobile-store/pages/Listings"));
const PropertyDetail = lazy(() => import("@template-mobile-store/pages/PropertyDetail"));
const Developments = lazy(() => import("@template-mobile-store/pages/Developments"));
const Blog = lazy(() => import("@template-mobile-store/pages/Blog"));
const BlogPost = lazy(() => import("@template-mobile-store/pages/BlogPost"));
const Team = lazy(() => import("@template-mobile-store/pages/Team"));
const AgentProfile = lazy(() => import("@template-mobile-store/pages/AgentProfile"));
const Contact = lazy(() => import("@template-mobile-store/pages/Contact"));
const FAQ = lazy(() => import("@template-mobile-store/pages/FAQ"));
const Reviews = lazy(() => import("@template-mobile-store/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-mobile-store/pages/ServiceAreas"));
const CityLanding = lazy(() => import("@template-mobile-store/pages/CityLanding"));
const Compare = lazy(() => import("@template-mobile-store/pages/Compare"));
const TestDrive = lazy(() => import("@template-mobile-store/pages/TestDrive"));
const TestDriveConfirmation = lazy(() => import("@template-mobile-store/pages/TestDriveConfirmation"));
const ValueYourTrade = lazy(() => import("@template-mobile-store/pages/ValueYourTrade"));
const Finance = lazy(() => import("@template-mobile-store/pages/Finance"));
const NewVehicles = lazy(() => import("@template-mobile-store/pages/NewVehicles"));
const UsedVehicles = lazy(() => import("@template-mobile-store/pages/UsedVehicles"));
const CertifiedPreOwned = lazy(() => import("@template-mobile-store/pages/CertifiedPreOwned"));
const Offers = lazy(() => import("@template-mobile-store/pages/Offers"));
const ServiceParts = lazy(() => import("@template-mobile-store/pages/ServiceParts"));
const DigitalRetail = lazy(() => import("@template-mobile-store/pages/DigitalRetail"));
const DealerAdmin = lazy(() => import("@template-mobile-store/pages/DealerAdmin"));
const Cart = lazy(() => import("@template-mobile-store/pages/Cart"));
const Checkout = lazy(() => import("@template-mobile-store/pages/Checkout"));
const Stores = lazy(() => import("@template-mobile-store/pages/Stores"));
const Repairs = lazy(() => import("@template-mobile-store/pages/Repairs"));
const Account = lazy(() => import("@template-mobile-store/pages/Account"));
