  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`See what Austin shoppers say about ${COMPANY.name} — device advice, trade-ins, repairs, and pickup.`}
        />
      </Helmet>
      ...
      <HarborPageHero
        ...
        title="Trusted Across Austin"
        eyebrowAfter={`${siteTop.ratingValue} Stars · ${siteTop.ratingCount} ${siteTop.ratingLabel}`}
        body="Real feedback from customers who upgraded phones, traded in devices, and visited our repair bars."
        image={HOME_BUILDER_IMAGES.reviewsHero}
        imageAlt="Customer with smartphone"
      />
      ...
      <section className="section-padding-inset bg-[hsl(var(--primary))] text-white">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-white/75 mt-2 text-sm max-w-lg">
              Shop online, visit a store, or book a repair — our team is ready to help.
            </p>
          </div>
          <Button
            asChild
      ...
      <CTASection
        title="Experience Nexora Mobile"
        subtitle="Same-day pickup, certified repairs, and honest trade-in values at four Austin stores."
        primaryLabel="VISIT A STORE"
