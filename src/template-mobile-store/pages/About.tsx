...
import { Award, ShieldCheck, Smartphone, Tag } from "lucide-react";
...
import { ABOUT_HERO_BADGES, ABOUT_TIMELINE, AWARDS, LUXURY_IMAGES } from "@template-mobile-store/data/siteData";

const badgeIconMap = { Smartphone, ShieldCheck, Award, Tag } as const;
        ...
        <div className="container-custom container-inset grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Nexora Mobile started with a simple idea: buying a phone should feel as premium as the device in your hand — clear pricing, honest trade-ins, and support that lasts.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Today our specialists serve shoppers across four Austin stores and online, with repairs, financing, and business fleet services under one roof.
            </p>
          </div>
        </div>
      </section>
