  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Meet the mobile specialists at ${COMPANY.name} — sales, repairs, trade-in, and business fleet support across Austin.`}
        />
      </Helmet>
      ...
      <section className="bg-[hsl(var(--primary))] text-white dealer-header-offset pb-12 sm:pb-16 lg:pb-20 relative overflow-hidden">
        ...
        <div className="relative container-custom container-inset">
          ...
          <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
            Product specialists for new, refurbished, and flagship devices — plus repair leads and digital retail experts.
          </p>
        </div>
      </section>
      ...
      {sectionVisibility["team.cta"] ? (
        <CTASection
          title="Work with our mobile specialists"
          subtitle="Sales, repairs, trade-in, and business fleet support across four Austin stores."
        />
      ) : null}
    </Layout>
  );
