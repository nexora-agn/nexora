  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Latest phone launches, pre-orders, and limited-stock flagships at Nexora Mobile." />
      </Helmet>
      ...
      <section className="bg-[hsl(var(--primary))] text-white dealer-header-offset pb-10 sm:pb-12 lg:pb-14">
        <div className="container-custom container-inset">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-medium">Latest Devices</h1>
        </div>
      </section>

      <section className="section-padding-inset space-y-12 lg:space-y-16">
