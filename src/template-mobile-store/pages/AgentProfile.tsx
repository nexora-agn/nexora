...
const AgentProfile = () => {
  ...
  return (
    <Layout>
      ...
      <section className="dealer-header-offset pb-12 sm:pb-16 bg-[hsl(var(--muted))]">
        <div className="container-custom container-inset grid lg:grid-cols-3 gap-8 lg:gap-12 items-start">
