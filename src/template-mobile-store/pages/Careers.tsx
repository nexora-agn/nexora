        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-base md:text-lg text-white/85 leading-relaxed max-w-md">
              Every Nexora Mobile store follows device-handling and customer-data protocols. Every employee can escalate privacy or safety concerns. We publish these metrics because partners and business customers ask for them.
            </p>
          </div>
