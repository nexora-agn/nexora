  ...
  return (
    <Layout>
      ...
      <HarborPageHero
        ...
        body="Visit any Nexora Mobile store for demos, same-day pickup, trade-ins, and certified repairs."
        image={HOME_BUILDER_IMAGES.showroom}
        imageAlt="Mobile phone retail store"
        dark={false}
      />
