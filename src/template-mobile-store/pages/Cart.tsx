...
import { getCart, updateQty, removeFromCart, type CartLine } from "@template-mobile-store/lib/cart";
...
import { formatCurrency } from "@template-mobile-store/lib/mortgageCalculator";
