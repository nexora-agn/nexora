...
export const SERVICES = [
  { id: "commercial-construction", title: "Commercial Construction", icon: "Building2", description: "Office buildings, retail spaces, warehouses and more.", image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&h=400&fit=crop" },
  { id: "residential-construction", title: "Residential Construction", icon: "Home", description: "Custom homes, additions, remodels and everything in between.", image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=600&h=400&fit=crop" },
  { id: "construction-management", title: "Construction Management", icon: "HardHat", description: "Expert project management to ensure quality, timelines and budgets.", image: "https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=600&h=400&fit=crop" },
  { id: "design-build", title: "Design-Build Services", icon: "DraftingCompass", description: "One team from start to finish for a seamless building experience.", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=400&fit=crop" },
  { id: "renovation", title: "Renovation & Additions", icon: "Hammer", description: "Transform your space with our renovation and expansion services.", image: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=600&h=400&fit=crop" },
  { id: "green-building", title: "Green Building", icon: "Leaf", description: "Sustainable construction practices for an eco-friendly future.", image: "https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?w=600&h=400&fit=crop" },
];

export const PROJECTS = [
  { id: "corporate-office", title: "Corporate Office Building", category: "Commercial", location: "Dallas, TX", year: "2024", client: "Skyline Development Corp", value: "$28M", description: "A modern Class-A corporate headquarters with sustainable design and Class-A finishes throughout.", image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=600&fit=crop", gallery: ["https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&h=800&fit=crop", "https://images.unsplash.com/photo-1600210492493-0946911123ea?w=1200&h=800&fit=crop"] },
  { id: "modern-home", title: "Modern Custom Home", category: "Residential", location: "Fort Worth, TX", year: "2024", client: "Private Client", value: "$2.4M", description: "Custom 6,200 sqft contemporary residence with infinity pool, smart-home automation, and craft-millwork interiors.", image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&h=600&fit=crop", gallery: [] },
  { id: "retail-center", title: "Retail Shopping Center", category: "Commercial", location: "Frisco, TX", year: "2023", client: "Northshore Retail Group", value: "$18M", description: "Open-air retail destination featuring 28 storefronts, food hall, and dedicated parking structure.", image: "https://images.unsplash.com/photo-1494526585095-c41746248156?w=800&h=600&fit=crop", gallery: [] },
  { id: "commercial-warehouse", title: "Commercial Warehouse", category: "Industrial", location: "Arlington, TX", year: "2023", client: "Logistics Partners LLC", value: "$12M", description: "180,000 sqft tilt-wall distribution facility with 32-foot clear heights and 22 dock doors.", image: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=600&fit=crop", gallery: [] },
  { id: "luxury-residence", title: "Hilltop Luxury Estate", category: "Residential", location: "Plano, TX", year: "2023", client: "Private Client", value: "$4.5M", description: "Bespoke 8,500 sqft estate with guest house, wine room, and resort-style outdoor living.", image: "https://images.unsplash.com/photo-1593696140826-c58b021acf8b?w=800&h=600&fit=crop", gallery: [] },
  { id: "medical-office", title: "Medical Office Plaza", category: "Commercial", location: "Dallas, TX", year: "2022", client: "North Texas Health Partners", value: "$22M", description: "Three-building medical campus with state-of-the-art diagnostic imaging and ambulatory surgery suite.", image: "https://images.unsplash.com/photo-1600210492493-0946911123ea?w=800&h=600&fit=crop", gallery: [] },
  { id: "boutique-hotel", title: "Boutique Hotel Renovation", category: "Hospitality", location: "Dallas, TX", year: "2022", client: "Hospitality Group of Texas", value: "$8.7M", description: "Full-property renovation of a 96-key boutique hotel including all guest rooms, lobby, and rooftop bar.", image: "https://images.unsplash.com/photo-1554995207-c18c203602cb?w=800&h=600&fit=crop", gallery: [] },
  { id: "tenant-improvement", title: "Corporate Tenant Improvement", category: "Commercial", location: "Fort Worth, TX", year: "2022", client: "Confidential Fortune 500", value: "$6.2M", description: "Phased after-hours tenant improvement of 110,000 sqft across three floors with no business interruption.", image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&h=600&fit=crop", gallery: [] },
  { id: "restaurant-buildout", title: "Flagship Restaurant Buildout", category: "Hospitality", location: "Plano, TX", year: "2024", client: "Summit Hospitality Inc.", value: "$3.1M", description: "From shell to opening night in 14 weeks: bespoke millwork bar, exhibition kitchen, and outdoor patio.", image: "https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=800&h=600&fit=crop", gallery: [] },
];
...
export const TEAM = [
  { id: "michael-summit", name: "Michael Summit", role: "Founder & CEO", bio: "Three decades of construction leadership, founder of Summit Construction in 2004.", image: "https://images.unsplash.com/photo-1521119989659-a83eee488004?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "sarah-chen", name: "Sarah Chen", role: "Director of Operations", bio: "Expert in operations and quality systems with deep commercial construction experience.", image: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "michael-rodriguez", name: "Michael Rodriguez", role: "Senior Project Manager", bio: "Delivered $400M+ in commercial projects across North Texas.", image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "emily-watson", name: "Emily Watson", role: "Design-Build Lead", bio: "Architect-led design-build delivery, including custom residential and commercial.", image: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "david-park", name: "David Park", role: "Chief Estimator", bio: "Detailed cost engineering and value-engineering across all market sectors.", image: "https://images.unsplash.com/photo-1463453091185-61582044d556?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "lisa-thompson", name: "Lisa Thompson", role: "Safety Director", bio: "OSHA-certified safety leader with an industry-leading EMR record.", image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
];

export const TESTIMONIALS = [
  { name: "Jason T.", role: "Dallas, TX", quote: "Summit Construction exceeded our expectations. The team was professional, communicative and delivered on time and within budget.", avatar: "https://images.unsplash.com/photo-1525134479668-1bee5c7c6845?w=200&h=200&fit=crop", rating: 5 },
  { name: "Sarah M.", role: "Fort Worth, TX", quote: "Their attention to detail and quality of work is unmatched. We will definitely use them for future projects.", avatar: "https://images.unsplash.com/photo-1495216875107-c6c043eb703f?w=200&h=200&fit=crop", rating: 5 },
  { name: "Michael R.", role: "Plano, TX", quote: "Honest, reliable and high quality work. It's rare to find a construction company you can truly trust.", avatar: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=200&h=200&fit=crop", rating: 5 },
  { name: "Linda K.", role: "Frisco, TX", quote: "From the first walk-through to the final punch list, they were on top of every detail. Highly recommended.", avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&h=200&fit=crop", rating: 5 },
  { name: "Carlos H.", role: "Arlington, TX", quote: "Best contractor we've ever worked with. Built our headquarters two weeks ahead of schedule.", avatar: "https://images.unsplash.com/photo-1463453091185-61582044d556?w=200&h=200&fit=crop", rating: 5 },
];

export const BLOG_POSTS = [
  { id: "future-of-construction", title: "The Future of Sustainable Construction", excerpt: "Exploring how green building practices are reshaping the construction industry.", date: "March 15, 2024", author: "Sarah Chen", category: "Sustainability", image: "https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?w=600&h=400&fit=crop", content: "Sustainable construction is no longer a trend. It's the future. From recycled materials to energy-efficient designs, the industry is evolving rapidly. At Summit Construction, we've embraced LEED certification standards across all our new projects.\n\nKey innovations include solar-integrated building materials, smart energy management systems, and water recycling infrastructure. These technologies not only reduce environmental impact but also lower long-term operational costs for building owners." },
  { id: "choosing-contractor", title: "How to Choose the Right Contractor", excerpt: "Key factors to consider when selecting a construction partner for your project.", date: "February 28, 2024", author: "Michael Summit", category: "Tips", image: "https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=600&h=400&fit=crop", content: "Choosing the right contractor can make or break your construction project. First, verify credentials and insurance. A reputable contractor should have proper licensing, bonding, and comprehensive insurance coverage.\n\nSecond, review their portfolio. Look for projects similar in scope and complexity to yours. Ask for references and actually contact them.\n\nThird, get detailed written estimates. Compare not just the bottom line, but the specifics of what's included." },
  { id: "smart-buildings", title: "Smart Building Technologies in 2024", excerpt: "How IoT and automation are transforming modern construction and building management.", date: "January 10, 2024", author: "David Park", category: "Technology", image: "https://images.unsplash.com/photo-1600210492493-0946911123ea?w=600&h=400&fit=crop", content: "Smart building technologies are revolutionizing how we design, construct, and manage buildings. From IoT sensors to AI-powered energy management, the possibilities are endless." },
  { id: "prefab-momentum", title: "Prefab Momentum in Urban Infill", excerpt: "Why modular assemblies are winning on tight city lots without sacrificing design intent.", date: "December 5, 2023", author: "Sarah Chen", category: "Technology", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=400&fit=crop", content: "Prefabrication is shedding its industrial-only reputation. On constrained sites, volumetric modules cut calendar time while holding tolerances that stick-built crews struggle to repeat." },
  { id: "site-safety-culture", title: "Building a Site Safety Culture That Sticks", excerpt: "Leading indicators, toolbox talks, and accountability from the GC down.", date: "November 18, 2023", author: "Michael Rodriguez", category: "Tips", image: "https://images.unsplash.com/photo-1502005229762-cf1b2da7c5d6?w=600&h=400&fit=crop", content: "Safety is not a poster. It is a daily choice reinforced by how we plan lifts, sequence trades, and debrief near misses." },
  { id: "cost-certainty", title: "Cost Certainty in Volatile Markets", excerpt: "How we lock allowances, hedge long-lead buys, and communicate trade-offs early.", date: "October 2, 2023", author: "Michael Summit", category: "Tips", image: "https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=600&h=400&fit=crop", content: "Owners deserve numbers they can plan around. We pair milestone pricing with transparent contingency bands and weekly burn reports." },
  { id: "mass-timber", title: "Mass Timber: Where Code and Craft Meet", excerpt: "A primer on hybrid structures, fire design, and supplier coordination.", date: "September 12, 2023", author: "Sarah Chen", category: "Sustainability", image: "https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?w=600&h=400&fit=crop", content: "Timber is no longer niche. With updated code paths and experienced fabricators, we deliver exposed structure without apologizing for performance." },
];
...
export const SERVICE_DEEP_DIVES: {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=900&h=700&fit=crop",
    inclusions: [
