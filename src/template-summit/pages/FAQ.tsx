...
import { FAQ_BY_CATEGORY, FAQ_TABS, FAQ_ITEMS as DEFAULT_FAQ_ITEMS, type FaqTabId } from "@template-summit/data/siteData";
    ...
    <Layout>
      ...
      <Reveal direction="zoom" duration={650}>
        <PageHeader
          ...
          subtitle="Everything you need to know about our construction services, processes, and standards."
        />
      </Reveal>
