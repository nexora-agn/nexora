...
const Team = () => {
  ...
  return (
    ...
    <PageHeader variant="dark" eyebrow="OUR TEAM & CAREERS" title="Senior-Led on Every Project" subtitle="Meet the leadership behind Summit Construction — and learn about open careers across project management, field operations, and design-build." />
