...
import ProcessSection from "@template-summit/components/home/ProcessSection";
  ...
  return (
    ...
    <Reveal direction="zoom" duration={650}>
      <PageHeader
        ...
        subtitle={`${COMPANY.name} is a full-service construction company focused on precision delivery, transparent communication, and measurable quality on every site.`}
      />
    </Reveal>
    ...
    {sectionVisibility["about.story"] && <Reveal delay={70}>
      ...
      <div className="container-custom px-4 md:px-8 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          <p className="text-xs font-bold tracking-[0.22em] text-secondary mb-3">OUR STORY</p>
          <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-primary mb-6 leading-[1.05]">Building Better, Brick By Brick.</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
            Since 2004 {COMPANY.name} has partnered with owners, developers, and design teams across Texas who expect clarity, not chaos, when budgets and schedules are on the line. Our teams integrate early so decisions made on paper survive contact with reality.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            From Dallas to Fort Worth, we bring the same playbook: senior leadership on site, milestone-based transparency, and craftsmanship that holds up to inspection and time.
          </p>
        </div>
        <img
    ...
    {sectionVisibility["about.directors"] && <Reveal delay={140}>
      <section className="section-padding bg-background">
      <div className="container-custom px-4 md:px-8">
        <p className="text-sm font-bold tracking-[0.2em] text-secondary text-center mb-2">LEADERSHIP</p>
        <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-primary text-center mb-12 leading-[1.05]">Meet the Directors</h2>
