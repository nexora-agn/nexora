...
const sections = [
  {
    ...
    body: (
      <p>
        These Terms of Service (&quot;Terms&quot;) govern your access to webready&apos;s website
  ...
  },
  {
    ...
    body: (
      <p>
        To the maximum extent permitted by law, webready shall not be liable for any indirect,
        ...
        exceed the fees paid to webready for the services giving rise to the claim during the six
  ...
  return (
    <SiteLayout>
      <PageHeader
        ...
        description="The terms that apply when you use our website and engage webready for services."
      />
