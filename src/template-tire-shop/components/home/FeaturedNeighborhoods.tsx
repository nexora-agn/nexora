...
import { NEIGHBORHOODS } from "@template-tire-shop/data/siteData";
  ...
  <section className="luxury-section bg-white">
    <div className="container-custom container-inset">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <p className="tire-eyebrow mb-3">Shop locations</p>
          <h2 className="tire-heading">Austin Tire Shops</h2>
        </div>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <div className="flex gap-6 text-xs uppercase tracking-wider mb-4">
                <span>{n.propertyCount}+ SKUs</span>
