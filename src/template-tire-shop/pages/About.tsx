...
import { Award, ShieldCheck, CircleDot, MapPin, Tag } from "lucide-react";
...
import AgentsSection from "@template-tire-shop/components/home/AgentsSection";
import { useSiteContent } from "@template-tire-shop/contexts/SiteContentContext";
import { ABOUT_HERO_BADGES, ABOUT_TIMELINE, AWARDS, LUXURY_IMAGES } from "@template-tire-shop/data/siteData";

const badgeIconMap = { CircleDot, ShieldCheck, Award, Tag, MapPin } as const;
        ...
        <div className="container-custom container-inset grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Nexora Tires started with a simple idea: finding the right tire should be as clear as reading a spec sheet — honest fitment advice, upfront pricing, and installs done to torque.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Today our ASE techs serve drivers across four Austin shops and online, with rotations, alignments, flat repair, seasonal storage, and fleet accounts under one roof.
            </p>
          </div>
        </div>
      </section>
