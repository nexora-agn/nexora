...
import { NEW_DEVELOPMENTS } from "@template-tire-shop/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Seasonal tire campaigns and limited-stock performance sets at Nexora Tires." />
      </Helmet>
