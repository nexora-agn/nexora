...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-electrical/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-electrical/contexts/SiteContentContext";
import { mergeSiteContentState } from "@/lib/drafts";
import ScrollToTop from "@template-electrical/components/ScrollToTop";
import ChatbotWidget from "@template-electrical/components/Chatbot/ChatbotWidget";
import Index from "@template-electrical/pages/Index";
import NotFound from "@template-electrical/pages/NotFound";
...
const About = lazy(() => import("@template-electrical/pages/About"));
const Services = lazy(() => import("@template-electrical/pages/Services"));
const ServiceDetail = lazy(() => import("@template-electrical/pages/ServiceDetail"));
const Projects = lazy(() => import("@template-electrical/pages/Projects"));
const ProjectDetail = lazy(() => import("@template-electrical/pages/ProjectDetail"));
const Blog = lazy(() => import("@template-electrical/pages/Blog"));
const BlogPost = lazy(() => import("@template-electrical/pages/BlogPost"));
const Team = lazy(() => import("@template-electrical/pages/Team"));
const Contact = lazy(() => import("@template-electrical/pages/Contact"));
const FAQ = lazy(() => import("@template-electrical/pages/FAQ"));
const Reviews = lazy(() => import("@template-electrical/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-electrical/pages/ServiceAreas"));
const Careers = lazy(() => import("@template-electrical/pages/Careers"));
