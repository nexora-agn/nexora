...
import ElectricalPageHero from "@template-electrical/components/sections/ElectricalPageHero";
...
import CTASection from "@template-electrical/components/sections/CTASection";
...
const EmergencyElectricalLayout = () => {
  ...
  return (
    <>
      <ElectricalPageHero
        breadcrumb={[{ label: "Home", to: "/" }, { label: "Services", to: "/services" }, { label: "Emergency Electrical" }]}
        title="24/7 Emergency Electrical"
        eyebrowAfter="Master Electricians · Same-Night Response"
        ...
        badges={
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { id: "master", t: "Master Electricians", I: ShieldCheck },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-white/80 leading-relaxed text-sm">
              Stay safe, shut off power if you can, and call VOLTCURRENT. We&apos;ll triage urgency and dispatch a master electrician — usually within 2–4 hours across DFW.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-3">
            <img
              src={ELECTRICAL_IMAGES.workerElectrician}
              alt="Electrical storm damage"
...
const ElectricalInspectionsLayout = () => {
  const { company: COMPANY } = useSiteContent();

  return (
    <>
      <ElectricalPageHero
        breadcrumb={[{ label: "Home", to: "/" }, { label: "Services", to: "/services" }, { label: "Electrical Inspections" }]}
      ...
      <section className="bg-[hsl(var(--volt-surface))] py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative rounded-lg overflow-hidden min-h-[280px]">
            <img
              src={ELECTRICAL_IMAGES.smartHome.replace("w=600", "w=900").replace("h=400", "h=700")}
  ...
  if (!svc) {
    return (
      <ElectricalPageHero
        ...
        body="That service doesn't exist. Browse our full electrical service catalog."
        image={ELECTRICAL_IMAGES.heroElectrician}
      />
    );
  }
  ...
  return (
    <>
      <ElectricalPageHero
        ...
        title={svc.title}
        eyebrowAfter={`${COMPANY.name} · Master Electricians`}
      ...
      <CTASection
        ...
        subtitle="Free estimates from licensed master electricians. Same-day service available across DFW."
      />
      <LeadContactSection />
    </>
  );
...
const ServiceDetail = () => {
  ...
  const title = svc ? `${svc.title} | ${COMPANY.name}` : `Electrical Services | ${COMPANY.name}`;
  const desc = svc?.description || `Electrical services from ${COMPANY.name} across Dallas–Fort Worth.`;
  ...
  return (
    <Layout>
      ...
      {id === "emergency-electrical" && <EmergencyElectricalLayout />}
      {id === "electrical-inspections" && <ElectricalInspectionsLayout />}
      {id !== "emergency-electrical" && id !== "electrical-inspections" && <GenericServiceLayout id={id} />}
    </Layout>
  );
};
