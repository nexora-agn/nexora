  ...
  return (
    <Layout>
      ...
      <ElectricalPageHero
        ...
        body="VOLTCURRENT dispatches master electricians throughout the Dallas–Fort Worth metro — from panel upgrades and EV chargers in Plano to commercial fit-outs in Irving and emergency repairs anywhere power fails."
        image={ELECTRICAL_IMAGES.panelUpgrade}
        imageAlt="Electrical service truck"
      />
