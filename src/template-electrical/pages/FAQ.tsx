...
import { FAQ_BY_CATEGORY, FAQ_TABS, FAQ_ITEMS as DEFAULT_FAQ_ITEMS, type FaqTabId } from "@template-electrical/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Answers about ${COMPANY.name} electrical services, emergency dispatch, pricing, permits, and warranties across DFW.`}
        />
      </Helmet>
      ...
      <ElectricalPageHero
        ...
        title="Electrical Questions Answered"
        body="Everything you need to know about our master electricians, emergency service, panel upgrades, EV chargers, and code-compliant work across Dallas–Fort Worth."
        image={ELECTRICAL_IMAGES.workerElectrician2}
