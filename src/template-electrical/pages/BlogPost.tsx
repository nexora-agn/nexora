...
import { BLOG_POSTS } from "@template-electrical/data/siteData";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {fallbackRelated.map(r => (
                <Link
                  key={r.id}
                  to={`/blog/${r.id}`}
                  className="group bg-[hsl(var(--volt-surface))] rounded-lg overflow-hidden border border-slate-100 hover:border-[hsl(var(--secondary))]/40 transition-all"
                >
