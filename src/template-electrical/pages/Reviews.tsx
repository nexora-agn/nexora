  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`See what DFW homeowners and businesses say about ${COMPANY.name} — master electricians, code-perfect work, and honest pricing.`}
        />
      </Helmet>
      ...
      <ElectricalPageHero
        ...
        title="Trusted Across DFW"
        eyebrowAfter={`${siteTop.ratingValue} Stars · ${siteTop.ratingCount} ${siteTop.ratingLabel}`}
        body="Real feedback from Dallas–Fort Worth homeowners and business owners who chose VOLTCURRENT for panel upgrades, EV chargers, emergency repairs, and commercial electrical work."
        image={ELECTRICAL_IMAGES.reviewsHero}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-white/75 mt-2 text-sm max-w-lg">
              Master electricians, upfront pricing, and code-perfect work across the Dallas metro.
            </p>
          </div>
          <Button
            asChild
      ...
      <CTASection
        title="Experience the VOLTCURRENT difference"
        subtitle="Same-day service available. Licensed Texas master electricians on every job."
