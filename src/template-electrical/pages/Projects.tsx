...
import PaginationControls from "@template-electrical/components/layout/PaginationControls";
...
import { PROJECTS_LATEST_PAGE_SIZE } from "@template-electrical/data/siteData";
import { clampPage, parsePageParam, slicePage, totalPages as totalPagesCount } from "@template-electrical/lib/pagination";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Electrical projects completed by ${COMPANY.name} — panel upgrades, EV chargers, commercial fit-outs, and more across DFW.`}
        />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-wide leading-tight">
              Code-Perfect Work Across DFW
            </h1>
            <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
              Panel upgrades, EV chargers, whole-home rewires, and commercial fit-outs — NEC-compliant installs with master electrician oversight from start to finish.
            </p>
          </div>
