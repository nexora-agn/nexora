...
import { ELECTRICAL_IMAGES } from "@template-electrical/data/siteData";
...
import { CONTACT_TRUST_STRIP } from "@template-electrical/data/siteData";
...
const Contact = () => {
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    setSubmitting(true);
    setTimeout(() => {
      toast.success("Thanks! A master electrician will reach out within one business day.");
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content={`Contact ${COMPANY.name} for free electrical estimates and 24/7 emergency service across DFW.`} />
      </Helmet>
      ...
      <ElectricalPageHero
        ...
        body="Free estimates, same-day service, and 24/7 emergency dispatch — reach out and a licensed master electrician will respond fast."
        image={ELECTRICAL_IMAGES.contactHero}
        imageAlt="Contact VOLTCURRENT Electric"
      />
      ...
      <section className="bg-[hsl(var(--primary))] text-white py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
          <div className="space-y-8">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4">
                ...
                <div>
                  <span className="block text-xs font-display font-bold uppercase tracking-wider text-white/60">Phone · 24/7 Emergency</span>
          ...
          <div className="bg-white text-[hsl(var(--primary))] rounded-lg p-6 lg:p-8 shadow-2xl">
            ...
            <p className="text-sm text-slate-500 mb-5">No obligation. Master electrician review within one business day.</p>
            <form onSubmit={onSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <textarea
                placeholder="Describe your electrical issue or project (optional)"
                rows={4}
            ...
            <p className="mt-3 text-[11px] text-slate-500 text-center">
              We respect your privacy. Your information stays with VOLTCURRENT.
            </p>
          </div>
        </div>
      </section>

      <section className="bg-[hsl(var(--volt-surface))] py-8 border-y border-slate-200">
