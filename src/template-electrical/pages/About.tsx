...
import { ABOUT_HERO_BADGES, ELECTRICAL_IMAGES } from "@template-electrical/data/siteData";
  ...
  return (
    <Layout>
      ...
      <ElectricalPageHero
        ...
        eyebrowAfter="Master Electricians. Local Roots."
        body={`${COMPANY.name} was built on a simple promise: every panel labeled, every connection torqued, and every homeowner treated with respect. We're Dallas master electricians — not a franchise, not a handyman with a voltage tester.`}
        image={ELECTRICAL_IMAGES.aboutHero}
        imageAlt="Master electrician at work"
        badges={
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {coreValues.map(v => {
              ...
              return (
                <article
                  key={v.id}
                  className="group rounded-sm border border-[hsl(var(--border))] bg-[hsl(var(--volt-surface))] p-6 hover:border-[hsl(var(--secondary))]/50 transition-colors"
                >
      ...
      <section className="bg-[hsl(var(--volt-surface))] py-12 border-t border-[hsl(var(--border))]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
