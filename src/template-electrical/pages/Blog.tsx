...
const Blog = () => {
  ...
  const titleBase = `Electrical Blog | ${COMPANY.name}`;
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Electrical tips, safety guides, and DFW homeowner advice from the ${COMPANY.name} master electricians.`}
        />
      </Helmet>
      ...
      <ElectricalPageHero
        ...
        body="Honest electrical advice from licensed master electricians — panel upgrades, EV chargers, surge protection, and safety tips for Dallas–Fort Worth homeowners."
        image={ELECTRICAL_IMAGES.blogHero}
        imageAlt="Electrical blog"
      />
