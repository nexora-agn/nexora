...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-painting/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-painting/contexts/SiteContentContext";
...
import ScrollToTop from "@template-painting/components/ScrollToTop";
import ChatbotWidget from "@template-painting/components/Chatbot/ChatbotWidget";
import Index from "@template-painting/pages/Index";
import NotFound from "@template-painting/pages/NotFound";
...
const About = lazy(() => import("@template-painting/pages/About"));
const Services = lazy(() => import("@template-painting/pages/Services"));
const ServiceDetail = lazy(() => import("@template-painting/pages/ServiceDetail"));
const Projects = lazy(() => import("@template-painting/pages/Projects"));
const ProjectDetail = lazy(() => import("@template-painting/pages/ProjectDetail"));
const Blog = lazy(() => import("@template-painting/pages/Blog"));
const BlogPost = lazy(() => import("@template-painting/pages/BlogPost"));
const Team = lazy(() => import("@template-painting/pages/Team"));
const Contact = lazy(() => import("@template-painting/pages/Contact"));
const FAQ = lazy(() => import("@template-painting/pages/FAQ"));
const Reviews = lazy(() => import("@template-painting/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-painting/pages/ServiceAreas"));
const Careers = lazy(() => import("@template-painting/pages/Careers"));
const Financing = lazy(() => import("@template-painting/pages/Financing"));
const CityLanding = lazy(() => import("@template-painting/pages/CityLanding"));
