...
import { PROJECTS_LATEST_PAGE_SIZE } from "@template-painting/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Painting projects completed by ${COMPANY.name} — interior, exterior, cabinets, commercial, and more across North Jersey.`}
        />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-wide leading-tight">
              Code-Perfect Work Across Central NJ
            </h1>
            <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
              Panel upgrades, water heaters, whole-home rewires, and commercial fit-outs — NEC-compliant installs with master painter oversight from start to finish.
            </p>
          </div>
