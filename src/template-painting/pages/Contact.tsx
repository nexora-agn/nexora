...
import { CONTACT_TRUST_STRIP } from "@template-painting/data/siteData";
  ...
  return (
    <Layout>
      ...
      <PaintingPageHero
        ...
        imageAlt="Contact BrushHouse Painting"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
          ...
          <div className="bg-white text-[hsl(var(--primary))] rounded-lg p-6 lg:p-8 shadow-2xl">
            ...
            <p className="mt-3 text-[11px] text-slate-500 text-center">
              We respect your privacy. Your information stays with BrushHouse Painting.
            </p>
          </div>
        </div>
      </section>
