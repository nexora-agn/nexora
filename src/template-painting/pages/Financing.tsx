...
import { FINANCING_CONTENT, PAINTING_IMAGES } from "@template-painting/data/siteData";
  ...
  return (
    <Layout>
      ...
      <PaintingPageHero
        ...
        body={content.body}
        image={content.image || PAINTING_IMAGES.financing}
