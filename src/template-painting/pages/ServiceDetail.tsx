...
import PaintingPageHero from "@template-painting/components/sections/PaintingPageHero";
...
import CTASection from "@template-painting/components/sections/CTASection";
...
import {
  ...
  PAINTING_IMAGES,
} from "@template-painting/data/siteData";
...
const EmergencypaintingLayout = () => {
  ...
  return (
    <>
      <PaintingPageHero
        breadcrumb={[{ label: "Home", to: "/" }, { label: "Services", to: "/services" }, { label: "Emergency painting" }]}
        title="Free estimate Emergency painting"
        eyebrowAfter="Master Painters · Same-Night Response"
        body="When the pipes burst or something smells wrong, you need a licensed master — not a handyman with a proper tools. BrushHouse Painting rolls stocked trucks across Central NJ to isolate faults, make safe repairs, and stop the leak."
        image={PAINTING_IMAGES.heroHome}
        imageAlt="Emergency painter"
        badges={
          <div className="flex flex-wrap gap-3">
            {[
              { id: "dispatch", t: "Free estimate Dispatch", I: Flame },
              { id: "master", t: "Master Painters", I: ShieldCheck },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-white/80 leading-relaxed text-sm">
              Stay safe, shut off your water main if you can, and call BrushHouse Painting. We&apos;ll triage urgency and dispatch a master painter — usually within 2–4 hours across Central NJ.
            </p>
...
const paintingInspectionsLayout = () => {
  ...
  return (
    <>
      <PaintingPageHero
        breadcrumb={[{ label: "Home", to: "/" }, { label: "Services", to: "/services" }, { label: "painting Inspections" }]}
      ...
      <section className="bg-[hsl(var(--flow-surface))] py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="font-display text-center text-2xl sm:text-3xl font-bold uppercase tracking-wide text-[hsl(var(--primary))] mb-10">
            Benefits of painting Inspections
          </h2>
      ...
      <section className="bg-[hsl(var(--flow-surface))] py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative rounded-lg overflow-hidden min-h-[280px] bg-[hsl(var(--primary))]">
            <img
              src={PAINTING_IMAGES.modernLiving}
              alt="painting panel inspection"
  ...
  if (!svc) {
    return (
      <PaintingPageHero
        ...
        body="That service doesn't exist. Browse our full painting service catalog."
        image={PAINTING_IMAGES.heroHome}
      />
    );
  }
  ...
  return (
    <>
      <PaintingPageHero
        ...
        title={svc.title}
        eyebrowAfter={`${COMPANY.name} · Master Painters`}
      ...
      <CTASection
        ...
        subtitle="Free estimates from licensed master painters. Same-day service available across Central NJ."
      />
      <LeadContactSection />
    </>
  );
...
const ServiceDetail = () => {
  ...
  const title = svc ? `${svc.title} | ${COMPANY.name}` : `Painting Services | ${COMPANY.name}`;
  const desc = svc?.description || `Painting services from ${COMPANY.name} across North Jersey.`;
