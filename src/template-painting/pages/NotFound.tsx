...
const QUICK_LINKS: Array<{ label: string; to: string; description: string }> = [
  { label: "Services", to: "/services", description: "Emergency painting, drains, water heaters, and full residential & commercial service." },
  { label: "Contact", to: "/contact", description: "Free estimates and convenient scheduling across Central New Jersey." },
  { label: "Emergency Service", to: "/services/emergency-painting", description: "Free estimate dispatch for burst pipes, leaks, and backups." },
];
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`This page could not be found. Return to ${COMPANY.name} for painting services in Central New Jersey.`}
        />
      </Helmet>
          ...
          <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <Link to="/services/emergency-painting" aria-label="Emergency painting service">
