...
import { ABOUT_HERO_BADGES, PAINTING_IMAGES } from "@template-painting/data/siteData";
  ...
  return (
    <Layout>
      ...
      <PaintingPageHero
        ...
        title="Craftsmanship You Can See in Every Coat"
        eyebrowAfter="Owner-Led. Prep-First. Warranty-Backed."
        body={`${COMPANY.name} was built on one belief: meticulous preparation and premium coatings turn houses into homes you're proud to show off. We're North Jersey painters — not a franchise, not a one-day crew.`}
        image={PAINTING_IMAGES.aboutHero}
        imageAlt="BrushHouse painter finishing interior trim"
        badges={
      ...
      <section className="bg-[hsl(var(--flow-surface))] py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 rounded-sm overflow-hidden ring-1 ring-[hsl(var(--border))]">
            <img
              src={PAINTING_IMAGES.aboutStudio}
              alt="BrushHouse painter repairing painting in a home"
