...
import { SEO_CITIES } from "@template-painting/data/seoCities";
  ...
  return (
    <Layout>
      ...
      <PaintingPageHero
        ...
        body="BrushHouse Painting dispatches licensed master painters throughout Central New Jersey — from emergency repairs and drain cleaning to water heaters, boilers, and leak detection."
        image={PAINTING_IMAGES.exteriorHouse}
        imageAlt="BrushHouse Painting service van"
        dark={false}
      />
      ...
      <section className="bg-white py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 rounded-sm overflow-hidden min-h-[360px] ring-1 ring-border">
            <iframe
              title="BrushHouse Painting service area map"
              src={mapEmbedUrl}
      ...
      <CTASection
        title="Need a painter in your area?"
        subtitle="Free estimate emergency dispatch and convenient scheduling across Central New Jersey."
