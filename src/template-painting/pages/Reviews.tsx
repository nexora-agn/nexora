  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`See what Central NJ homeowners and businesses say about ${COMPANY.name} — master painters, quality work, and honest pricing.`}
        />
      </Helmet>
      ...
      <PaintingPageHero
        ...
        body="Real feedback from Central New Jersey homeowners and business owners who chose BrushHouse Painting for drains, water heaters, emergency repairs, and commercial painting work."
      ...
      <CTASection
        title="Experience the BrushHouse Painting difference"
        subtitle="Same-day service available. Licensed Texas master painters on every job."
