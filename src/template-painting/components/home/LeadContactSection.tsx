...
const LeadContactSection = () => {
  ...
  return (
    <section id="estimate" className="section-padding bg-[hsl(var(--flow-warm))]">
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[480px] rounded-sm overflow-hidden border border-border paint-shadow-card">
