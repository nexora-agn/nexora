...
export const HOME_HERO = {
  ...
  image:
    "https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=1600&h=1200&fit=crop",
...
export const SERVICES = [
  { id: "roof-installation", title: "Roof Installation", icon: "Home", description: "Professional roof installation using high-quality materials for long-lasting durability.", image: "https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=600&h=400&fit=crop" },
  { id: "roof-repair", title: "Roof Repair", icon: "Wrench", description: "Fast and effective repair solutions for all types of roof damage.", image: "https://images.unsplash.com/photo-1597222909672-83c9c47e2cdf?w=600&h=400&fit=crop" },
  { id: "roof-replacement", title: "Roof Replacement", icon: "Hammer", description: "Complete roof replacement with modern and durable materials.", image: "https://images.unsplash.com/photo-1597047084897-51e81819a499?w=600&h=400&fit=crop" },
  { id: "roof-inspection", title: "Roof Inspection", icon: "ClipboardCheck", description: "Detailed inspections to identify issues before they become costly.", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop" },
  { id: "gutter-installation", title: "Gutter Installation", icon: "Droplets", description: "Protect your home with our seamless gutter installation.", image: "https://images.unsplash.com/photo-1542621334-a254cf47733d?w=600&h=400&fit=crop" },
  { id: "storm-damage", title: "Storm Damage Repair", icon: "CloudLightning", description: "We help restore your roof after storm damage quickly and efficiently.", image: "https://images.unsplash.com/photo-1605007493699-af65834f8a00?w=600&h=400&fit=crop" },
  { id: "emergency-repair", title: "Emergency Roof Repair", icon: "Zap", description: "24/7 emergency roof repair when leaks and storms can't wait.", image: "https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=600&h=400&fit=crop" },
  { id: "siding", title: "Siding", icon: "PanelTop", description: "Durable siding installation and repair to protect and beautify your home.", image: "https://images.unsplash.com/photo-1626885930974-4b69aa21bbf9?w=600&h=400&fit=crop" },
  { id: "commercial-roofing", title: "Commercial Roofing", icon: "Building2", description: "Reliable commercial roof installation, repair, and maintenance.", image: "https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?w=600&h=400&fit=crop" },
];

export const PROJECTS = [
  { id: "modern-asphalt", title: "Modern Asphalt Re-roof", category: "Residential", location: "Houston, TX", year: "2024", client: "Private Homeowner", value: "$18K", description: "Full tear-off and re-roof with architectural asphalt shingles, ice and water shield, and new flashing throughout.", image: "https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=800&h=600&fit=crop", gallery: ["https://images.unsplash.com/photo-1597047084897-51e81819a499?w=1200&h=800&fit=crop"] },
  { id: "metal-roof-estate", title: "Standing Seam Metal Roof", category: "Residential", location: "Austin, TX", year: "2024", client: "Private Client", value: "$42K", description: "Premium 24-gauge standing seam metal roof system with concealed fasteners and matching gutters.", image: "https://images.unsplash.com/photo-1597047084897-51e81819a499?w=800&h=600&fit=crop", gallery: [] },
  { id: "storm-restore", title: "Hail Storm Restoration", category: "Residential", location: "Dallas, TX", year: "2024", client: "Insurance Claim", value: "$26K", description: "Insurance-coordinated full roof replacement after severe hail event, including decking repair and gutter replacement.", image: "https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=800&h=600&fit=crop", gallery: [] },
  { id: "commercial-flat", title: "TPO Commercial Roof", category: "Commercial", location: "Houston, TX", year: "2023", client: "Logistics Partners", value: "$185K", description: "60-mil TPO single-ply membrane replacement on a 38,000 sqft distribution warehouse with tapered insulation.", image: "https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?w=800&h=600&fit=crop", gallery: [] },
  { id: "cedar-shake", title: "Cedar Shake Restoration", category: "Residential", location: "The Woodlands, TX", year: "2023", client: "Private Client", value: "$58K", description: "Hand-split cedar shake replacement with new copper valleys and stainless flashing for a heritage estate.", image: "https://images.unsplash.com/photo-1626885930974-4b69aa21bbf9?w=800&h=600&fit=crop", gallery: [] },
  { id: "gutter-system", title: "Seamless Gutter Install", category: "Residential", location: "Sugar Land, TX", year: "2023", client: "Private Homeowner", value: "$6.8K", description: "Custom seamless 6-inch aluminum gutters with leaf guards and downspout extensions around full perimeter.", image: "https://images.unsplash.com/photo-1542621334-a254cf47733d?w=800&h=600&fit=crop", gallery: [] },
  { id: "tile-replacement", title: "Clay Tile Replacement", category: "Residential", location: "Katy, TX", year: "2022", client: "Private Client", value: "$48K", description: "Spanish clay tile replacement with new underlayment system and copper accent flashing.", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&h=600&fit=crop", gallery: [] },
  { id: "office-flat", title: "Office Building Re-roof", category: "Commercial", location: "Dallas, TX", year: "2022", client: "Skyline Properties", value: "$92K", description: "Modified bitumen roof replacement on three-story office building with full insulation upgrade.", image: "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=800&h=600&fit=crop", gallery: [] },
  { id: "siding-refresh", title: "Full Home Siding", category: "Residential", location: "Pearland, TX", year: "2024", client: "Private Homeowner", value: "$32K", description: "Fiber-cement siding installation with new trim, soffits, and fascia for a refreshed exterior.", image: "https://images.unsplash.com/photo-1626885930974-4b69aa21bbf9?w=800&h=600&fit=crop", gallery: [] },
];
...
export const TEAM = [
  { id: "marcus-reid", name: "Marcus Reid", role: "Founder & Master Roofer", bio: "Two decades of roofing leadership. Founded Roofix in 2009.", image: "https://images.unsplash.com/photo-1521146764736-56c929d59c83?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "alicia-hayes", name: "Alicia Hayes", role: "Director of Operations", bio: "Runs scheduling, estimating, and the customer experience end-to-end.", image: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "kenji-okafor", name: "Kenji Okafor", role: "Senior Project Manager", bio: "Delivered hundreds of residential re-roofs and commercial replacements.", image: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "sara-blanco", name: "Sara Blanco", role: "Insurance Claims Lead", bio: "Helps homeowners navigate storm and hail insurance claims start to finish.", image: "https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "dwight-park", name: "Dwight Park", role: "Lead Estimator", bio: "Precise material take-offs and transparent quotes on every job.", image: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "lana-cole", name: "Lana Cole", role: "Safety Director", bio: "OSHA-certified safety leader. Owns site protocols across every crew.", image: "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=400&h=400&fit=crop", social: { linkedin: "#", twitter: "#" } },
];

export const TESTIMONIALS = [
  { name: "Michael T.", role: "Houston, TX", quote: "Roofix did an amazing job on our new roof. The team was professional, on time, and the quality is outstanding.", avatar: "https://images.unsplash.com/photo-1559717201-fbb671ff56b7?w=200&h=200&fit=crop", rating: 5 },
  { name: "Sarah L.", role: "Austin, TX", quote: "Great experience from start to finish. They explained everything clearly and the results exceeded our expectations.", avatar: "https://images.unsplash.com/photo-1496440737103-cd596325d314?w=200&h=200&fit=crop", rating: 5 },
  { name: "James R.", role: "Dallas, TX", quote: "Highly recommend Roofix. Honest pricing, great communication, and excellent workmanship.", avatar: "https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=200&h=200&fit=crop", rating: 5 },
  { name: "Diana K.", role: "Sugar Land, TX", quote: "After the storm, they handled everything with our insurance. Roof looks better than before.", avatar: "https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=200&h=200&fit=crop", rating: 5 },
  { name: "Carlos H.", role: "Katy, TX", quote: "Honest, reliable, and fast. They saved us thousands compared to the first quote we got.", avatar: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=200&h=200&fit=crop", rating: 5 },
];

export const BLOG_POSTS = [
  { id: "signs-new-roof", title: "5 Signs You Need a New Roof", excerpt: "How to tell whether it's time to replace your roof before bigger problems start.", date: "May 15, 2024", author: "Marcus Reid", category: "Roofing Tips", image: "https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=600&h=400&fit=crop", content: "Most roofs give clear warning signs long before they fail catastrophically. Curling shingles, granules in the gutters, daylight in the attic, and rising energy bills are the four most common signals it's time for a replacement.\n\nIf your roof is over 20 years old, even cosmetic damage is worth a professional inspection — small leaks compound fast in the attic deck below." },
  { id: "right-roofing-material", title: "How to Choose the Right Roofing Material", excerpt: "Asphalt, metal, tile, or cedar — picking the right system for your climate and budget.", date: "May 1, 2024", author: "Alicia Hayes", category: "Roofing Tips", image: "https://images.unsplash.com/photo-1597047084897-51e81819a499?w=600&h=400&fit=crop", content: "Architectural asphalt shingles remain the best value for most homeowners — 25-30 year warranty, broad color selection, and easy repairs. Metal roofs cost more upfront but can last 50+ years with minimal maintenance.\n\nTile and cedar are premium choices that look beautiful but require structure-rated decking and specialty installers. We walk you through each option during the free estimate." },
  { id: "spring-maintenance", title: "Spring Roof Maintenance Tips", excerpt: "The annual checklist that prevents emergency calls later in the year.", date: "April 22, 2024", author: "Kenji Okafor", category: "Maintenance", image: "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop", content: "Spring is the perfect time to clear winter debris, check flashing seals, and unclog gutters before summer storms arrive. A 30-minute inspection by a homeowner — or a free professional check — can catch issues worth thousands later." },
  { id: "regular-inspections-matter", title: "Why Regular Roof Inspections Matter", excerpt: "How a small inspection schedule can extend the life of any roof by 5+ years.", date: "April 10, 2024", author: "Marcus Reid", category: "Maintenance", image: "https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=600&h=400&fit=crop", content: "An annual or bi-annual inspection is the single best thing you can do for your roof. We document any wear, photograph problem areas, and give you a written report you can keep in your homeowner records." },
  { id: "storm-damage-claim", title: "Filing a Storm Damage Insurance Claim", excerpt: "Step-by-step guide for getting your hail or wind damage claim approved.", date: "March 28, 2024", author: "Sara Blanco", category: "Storm Damage", image: "https://images.unsplash.com/photo-1605007493699-af65834f8a00?w=600&h=400&fit=crop", content: "Document everything immediately after a storm: photos of the roof, the date, and any visible interior damage. Call your insurance company within 48 hours and request a professional roof inspection before any temporary repairs." },
  { id: "metal-vs-asphalt", title: "Metal vs Asphalt: Which Is Right for You?", excerpt: "An honest cost-benefit comparison from a contractor who installs both.", date: "March 5, 2024", author: "Marcus Reid", category: "Roofing Tips", image: "https://images.unsplash.com/photo-1597047084897-51e81819a499?w=600&h=400&fit=crop", content: "Asphalt wins on upfront cost — typically half the price of metal. Metal wins on longevity, energy efficiency, and resale value. Both are excellent when installed correctly." },
  { id: "gutter-importance", title: "Why Gutters Are Critical to Your Roof", excerpt: "Clogged or undersized gutters cause more roof damage than most homeowners realize.", date: "February 18, 2024", author: "Kenji Okafor", category: "Maintenance", image: "https://images.unsplash.com/photo-1542621334-a254cf47733d?w=600&h=400&fit=crop", content: "Water that doesn't drain off your roof goes somewhere — usually into the fascia, soffits, and eventually the attic deck. A properly sized seamless gutter system is one of the cheapest ways to protect a roof." },
];
...
export const SERVICE_DEEP_DIVES: {
...
}[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=900&h=700&fit=crop",
    inclusions: [
