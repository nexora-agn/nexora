        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <p className="mt-6 text-base md:text-lg text-white/85 max-w-xl leading-relaxed">
              We provide professional roofing services using top-quality
              materials and expert craftsmanship to ensure a durable and
              beautiful roof for years to come.
            </p>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl ring-1 ring-white/10 shadow-2xl shadow-black/40">
              <img
                src="https://images.unsplash.com/photo-1632759145355-e9d2c00ec600?w=1100&h=900&fit=crop"
                alt="Quality roofing installation by Roofix"
            ...
            <div className="absolute -bottom-8 right-4 sm:-right-4 max-w-xs rounded-xl bg-white text-foreground p-5 shadow-2xl shadow-black/40 border border-white/40">
              ...
              <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
                We back every job with a lifetime workmanship warranty and a
