...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-luxury-real-estate/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-luxury-real-estate/contexts/SiteContentContext";
...
import ScrollToTop from "@template-luxury-real-estate/components/ScrollToTop";
import Index from "@template-luxury-real-estate/pages/Index";
import NotFound from "@template-luxury-real-estate/pages/NotFound";
import type { Draft } from "@/lib/supabase";

const SHOW_TEMPLATE_CHATBOT = false;

const About = lazy(() => import("@template-luxury-real-estate/pages/About"));
const Services = lazy(() => import("@template-luxury-real-estate/pages/Services"));
const ServiceDetail = lazy(() => import("@template-luxury-real-estate/pages/ServiceDetail"));
const Listings = lazy(() => import("@template-luxury-real-estate/pages/Listings"));
const PropertyDetail = lazy(() => import("@template-luxury-real-estate/pages/PropertyDetail"));
const Developments = lazy(() => import("@template-luxury-real-estate/pages/Developments"));
const Blog = lazy(() => import("@template-luxury-real-estate/pages/Blog"));
const BlogPost = lazy(() => import("@template-luxury-real-estate/pages/BlogPost"));
const Team = lazy(() => import("@template-luxury-real-estate/pages/Team"));
const AgentProfile = lazy(() => import("@template-luxury-real-estate/pages/AgentProfile"));
const Contact = lazy(() => import("@template-luxury-real-estate/pages/Contact"));
const FAQ = lazy(() => import("@template-luxury-real-estate/pages/FAQ"));
const Reviews = lazy(() => import("@template-luxury-real-estate/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-luxury-real-estate/pages/ServiceAreas"));
const CityLanding = lazy(() => import("@template-luxury-real-estate/pages/CityLanding"));
