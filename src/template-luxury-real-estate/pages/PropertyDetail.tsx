...
import { toggleFavorite, isFavorite } from "@template-luxury-real-estate/lib/favorites";
import { calculateMortgage, formatCurrency } from "@template-luxury-real-estate/lib/mortgageCalculator";
