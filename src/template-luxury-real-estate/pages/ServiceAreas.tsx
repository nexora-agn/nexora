...
import { HOME_BUILDER_IMAGES, SERVICE_AREA_COUNTIES } from "@template-luxury-real-estate/data/siteData";
import { SEO_CITIES } from "@template-luxury-real-estate/data/seoCities";
import HarborPageHero from "@template-luxury-real-estate/components/sections/HarborPageHero";
import CTASection from "@template-luxury-real-estate/components/sections/CTASection";
import { useSiteContent } from "@template-luxury-real-estate/contexts/SiteContentContext";
import { SERVICE_AREAS } from "@template-luxury-real-estate/data/siteData";
