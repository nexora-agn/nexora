...
import { SEO_CITIES } from "@template-landscaping/data/seoCities";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${COMPANY.name} serves Somerset, Morris, Hunterdon, Essex, and Union counties with residential and commercial painting — Free estimate emergency service.`}
        />
      </Helmet>
      ...
      <VerdePageHero
        ...
        body="VerdeField Landscaping dispatches licensed master painters throughout Central New Jersey — from emergency repairs and drain cleaning to water heaters, boilers, and leak detection."
        image={LANDSCAPING_IMAGES.residentialYard}
        imageAlt="VerdeField Landscaping service van"
        dark={false}
      />
      ...
      <section className="bg-white py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 rounded-sm overflow-hidden min-h-[360px] ring-1 ring-border">
            <iframe
              title="VerdeField Landscaping service area map"
              src={mapEmbedUrl}
      ...
      <CTASection
        title="Need landscaping in your area?"
        subtitle="Free property walkthroughs, maintenance routes, and 24/7 emergency tree service across North Jersey."
