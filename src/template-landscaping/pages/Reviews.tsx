  ...
  return (
    <Layout>
      ...
      <VerdePageHero
        ...
        body="Real feedback from Central New Jersey homeowners and business owners who chose VerdeField Landscaping for drains, water heaters, emergency repairs, and commercial painting work."
      ...
      <CTASection
        title="Experience the VerdeField difference"
