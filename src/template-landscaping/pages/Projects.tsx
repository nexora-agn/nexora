...
import PaginationControls from "@template-landscaping/components/layout/PaginationControls";
...
import { PROJECTS_LATEST_PAGE_SIZE } from "@template-landscaping/data/siteData";
import { clampPage, parsePageParam, slicePage, totalPages as totalPagesCount } from "@template-landscaping/lib/pagination";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Landscaping and tree service projects by ${COMPANY.name} — design, hardscape, lawn care, and commercial grounds across North Jersey.`}
        />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-wide leading-tight">
              Outdoor Transformations Across North Jersey
            </h1>
            <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
              Backyard makeovers, tree care, hardscape patios, and commercial grounds — design-build crews with ISA-certified arborists from concept through maintenance.
            </p>
          </div>
