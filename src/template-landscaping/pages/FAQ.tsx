...
import { FAQ_BY_CATEGORY, FAQ_TABS, FAQ_ITEMS as DEFAULT_FAQ_ITEMS, type FaqTabId } from "@template-landscaping/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Answers about ${COMPANY.name} painting services, emergency dispatch, pricing, permits, and warranties across Central NJ.`}
        />
      </Helmet>
      ...
      <VerdePageHero
        ...
        title="painting Questions Answered"
        body="Everything you need to know about our master painters, emergency service, drains, water heaters, and code-compliant work across Central New Jersey."
        image={LANDSCAPING_IMAGES.crewWorking}
        imageAlt="painting panel"
      />
        ...
        <section className="bg-white py-14 border-t border-slate-200">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-slate-600 mb-8 leading-relaxed">
              Can&apos;t find what you need? Call our master painters or request a free estimate — we&apos;re happy to help.
            </p>
