  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Meet the master painters and specialists behind ${COMPANY.name} — licensed, local, and committed to quality work across Central NJ.`}
        />
      </Helmet>
      ...
      <section className="bg-[hsl(var(--primary))] text-white py-14 lg:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-wide leading-tight max-w-2xl">
            Master Painters You Can Trust
          </h1>
          <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
            Texas-licensed masters, water heater specialists, and commercial leads — the crew that shows up when the power&apos;s out and stays until the panel is labeled right.
          </p>
        </div>
      </section>
      ...
      {sectionVisibility["team.cta"] ? (
        <CTASection
          title="Work with our VerdeField crew"
