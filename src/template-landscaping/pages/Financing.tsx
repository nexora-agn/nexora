...
import { FINANCING_CONTENT, LANDSCAPING_IMAGES } from "@template-landscaping/data/siteData";
  ...
  return (
    <Layout>
      ...
      <VerdePageHero
        ...
        body={content.body}
        image={content.image || LANDSCAPING_IMAGES.financing}
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <Reveal delay={80}>
              <img
                src={LANDSCAPING_IMAGES.financing}
                alt=""
