...
import VerdePageHero from "@template-landscaping/components/sections/VerdePageHero";
...
import CTASection from "@template-landscaping/components/sections/CTASection";
  ...
  return (
    <>
      <VerdePageHero
        ...
        body="When storms bring down limbs or trees threaten your home, you need certified arborists — not untrained crews. VerdeField dispatches rigging teams across North Jersey to secure hazards and restore safety."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-white/80 leading-relaxed text-sm">
              Stay clear of downed lines and damaged trees, then call VerdeField. We triage urgency and dispatch certified crews — often within 2–4 hours across North Jersey.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-3">
            <img
              src={LANDSCAPING_IMAGES.crewWorking}
      ...
      <section className="bg-[hsl(var(--flow-surface))] py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative rounded-lg overflow-hidden min-h-[280px] bg-[hsl(var(--primary))]">
            <img
              src={LANDSCAPING_IMAGES.luxuryBackyard}
  ...
  if (!svc) {
    return (
      <VerdePageHero
        ...
        body="That service doesn't exist. Browse our full landscaping and tree service catalog."
        image={LANDSCAPING_IMAGES.heroHome}
      />
    );
  }
  ...
  return (
    <>
      ...
      <CTASection
        ...
        subtitle="Free property walkthroughs from licensed landscaping and tree care crews across North Jersey."
      />
      <LeadContactSection />
    </>
  );
...
const ServiceDetail = () => {
  ...
  const title = svc ? `${svc.title} | ${COMPANY.name}` : `Landscaping Services | ${COMPANY.name}`;
