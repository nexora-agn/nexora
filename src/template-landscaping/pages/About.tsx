...
import { ABOUT_HERO_BADGES, LANDSCAPING_IMAGES } from "@template-landscaping/data/siteData";
  ...
  return (
    <Layout>
      ...
      <VerdePageHero
        ...
        title="Rooted in North Jersey. Built on Trust."
        eyebrowAfter="Family Owned · ISA Arborists · Design-Build."
        body={`${COMPANY.name} was built on one belief: outdoor spaces should feel intentional, safe, and beautiful year-round. We're local landscaping and tree care specialists — not a franchise, not a seasonal fly-by crew.`}
        image={LANDSCAPING_IMAGES.aboutHero}
        imageAlt="VerdeField landscaping crew on site"
        badges={
      ...
      <section className="bg-[hsl(var(--flow-surface))] py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 rounded-sm overflow-hidden ring-1 ring-[hsl(var(--border))]">
            <img
              src={LANDSCAPING_IMAGES.aboutCrew}
              alt="VerdeField crew completing a landscape installation"
