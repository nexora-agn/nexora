...
const WhatWeOfferGrid = () => {
  ...
  return (
    <section className="vf-section-pad bg-[hsl(var(--vf-sage))]/50">
      <div className="container-custom container-inset">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground font-sans-brand max-w-xl mx-auto">
            Tree care, hardscaping, and full-property landscaping — one trusted team for your entire yard.
          </p>
        </div>
          ...
          {capabilities.map(cap => {
            ...
            return (
              <Link
                key={cap.id}
                to={cap.to || "/services"}
                className="group rounded-xl bg-white border border-border p-6 vf-card-hover"
              >
