...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-landscaping/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-landscaping/contexts/SiteContentContext";
...
const ServiceDetail = lazy(() => import("@template-landscaping/pages/ServiceDetail"));
const Projects = lazy(() => import("@template-landscaping/pages/Projects"));
const ProjectDetail = lazy(() => import("@template-landscaping/pages/ProjectDetail"));
const Blog = lazy(() => import("@template-landscaping/pages/Blog"));
const BlogPost = lazy(() => import("@template-landscaping/pages/BlogPost"));
const Team = lazy(() => import("@template-landscaping/pages/Team"));
const Contact = lazy(() => import("@template-landscaping/pages/Contact"));
const FAQ = lazy(() => import("@template-landscaping/pages/FAQ"));
const Reviews = lazy(() => import("@template-landscaping/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-landscaping/pages/ServiceAreas"));
const Careers = lazy(() => import("@template-landscaping/pages/Careers"));
const Financing = lazy(() => import("@template-landscaping/pages/Financing"));
const CityLanding = lazy(() => import("@template-landscaping/pages/CityLanding"));
