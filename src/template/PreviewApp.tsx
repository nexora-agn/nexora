...
const ServiceDetail = lazy(() => import("@template/pages/ServiceDetail"));
const Projects = lazy(() => import("@template/pages/Projects"));
const ProjectDetail = lazy(() => import("@template/pages/ProjectDetail"));
const Blog = lazy(() => import("@template/pages/Blog"));
const BlogPost = lazy(() => import("@template/pages/BlogPost"));
const Team = lazy(() => import("@template/pages/Team"));
const Contact = lazy(() => import("@template/pages/Contact"));
const FAQ = lazy(() => import("@template/pages/FAQ"));
