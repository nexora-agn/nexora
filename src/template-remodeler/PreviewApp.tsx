...
import {
  ...
  THEME_DEFAULTS,
  type ThemeConfig,
} from "@template-remodeler/contexts/ThemeContext";
import {
  SiteContentProvider,
  SITE_CONTENT_DEFAULTS,
  type SiteContentState,
} from "@template-remodeler/contexts/SiteContentContext";
...
import ScrollToTop from "@template-remodeler/components/ScrollToTop";
import ChatbotWidget from "@template-remodeler/components/Chatbot/ChatbotWidget";
import Index from "@template-remodeler/pages/Index";
import NotFound from "@template-remodeler/pages/NotFound";
...
const About = lazy(() => import("@template-remodeler/pages/About"));
const Services = lazy(() => import("@template-remodeler/pages/Services"));
const ServiceDetail = lazy(() => import("@template-remodeler/pages/ServiceDetail"));
const Projects = lazy(() => import("@template-remodeler/pages/Projects"));
const ProjectDetail = lazy(() => import("@template-remodeler/pages/ProjectDetail"));
const Blog = lazy(() => import("@template-remodeler/pages/Blog"));
const BlogPost = lazy(() => import("@template-remodeler/pages/BlogPost"));
const Team = lazy(() => import("@template-remodeler/pages/Team"));
const Contact = lazy(() => import("@template-remodeler/pages/Contact"));
const FAQ = lazy(() => import("@template-remodeler/pages/FAQ"));
const Reviews = lazy(() => import("@template-remodeler/pages/Reviews"));
const ServiceAreas = lazy(() => import("@template-remodeler/pages/ServiceAreas"));
const Careers = lazy(() => import("@template-remodeler/pages/Careers"));
const Financing = lazy(() => import("@template-remodeler/pages/Financing"));
const Process = lazy(() => import("@template-remodeler/pages/Process"));
const Resources = lazy(() => import("@template-remodeler/pages/Resources"));
const CityLanding = lazy(() => import("@template-remodeler/pages/CityLanding"));
