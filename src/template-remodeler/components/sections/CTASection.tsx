...
const CTASection = ({
  ...
  subtitle = "Tell us about your kitchen, bath, basement, or exterior project — we'll respond within one business day.",
  ...
  return (
    <section
      className={
        tone === "muted"
          ? "rm-section-pad section-padding bg-[hsl(var(--rm-linen))] border-t border-border"
          : "rm-section-pad section-padding bg-white border-t-2 border-[hsl(var(--secondary))]"
      }
    >
