  ...
  return (
    <section
      className={cn(
        ...
        useDark ? "bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))]" : "bg-[hsl(var(--rm-warm-white))]",
        className,
      )}
    >
      <div className="container-custom container-inset py-10 md:py-14">
        <div className={cn("grid gap-8 items-center", image ? "lg:grid-cols-12" : "")}>
          <div className={image ? "lg:col-span-7" : ""}>
            ...
            <div className={cn("rm-rule my-5", useDark && "bg-[hsl(var(--secondary))]")} />
          ...
          {image && (
            <div className="lg:col-span-5">
              <img
                src={image}
                alt={imageAlt || title}
                className="w-full aspect-[16/10] object-cover border border-border rm-frame"
              />
            </div>
          )}
        </div>
