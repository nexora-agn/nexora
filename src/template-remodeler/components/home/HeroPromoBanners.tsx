...
import { LEAD_MAGNET, REMODELER_IMAGES } from "@template-remodeler/data/siteData";
import { Button } from "@/components/ui/button";

/** GTG-style lead magnet — single prominent split section, not 3 dark promo tiles */
const HeroPromoBanners = () => (
  <section className="border-y border-border bg-[hsl(var(--rm-bronze-light))]/50">
    <div className="grid lg:grid-cols-2">
      ...
      <div className="relative min-h-[280px] lg:min-h-full order-1 lg:order-2">
        <img
          ...
          alt="Home remodel planning guide"
    ...
    <div className="grid md:grid-cols-2 border-t border-border">
      <Link
        to="/projects"
        className="group flex items-center gap-6 p-8 md:p-10 bg-white border-b md:border-b-0 md:border-r border-border hover:bg-[hsl(var(--rm-linen))] transition-colors"
      >
        <img
          src={REMODELER_IMAGES.heroPortfolio}
          alt=""
        ...
        <span>
          ...
          <span className="block text-sm text-muted-foreground font-sans-brand mt-1">
            Home remodels across Central NJ
          </span>
        </span>
      ...
      <Link
        to="/process"
        className="group flex items-center gap-6 p-8 md:p-10 bg-white hover:bg-[hsl(var(--rm-linen))] transition-colors"
      >
        <img
          src={REMODELER_IMAGES.heroProcess}
          alt=""
          className="h-20 w-28 object-cover shrink-0 hidden sm:block"
        />
        <span>
