...
import { SERVICE_CATEGORY_TABS } from "@template-remodeler/data/siteData";
  ...
  return (
    <section className="rm-section-pad bg-white">
      <div className="container-custom container-inset">
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-sm font-sans-brand font-semibold transition-all ${
                i === active
                  ...
                  : "bg-[hsl(var(--muted))] text-muted-foreground hover:bg-[hsl(var(--rm-sage))]"
              }`}
            >
              {t.label}
            </button>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center rounded-2xl border border-border overflow-hidden bg-[hsl(var(--rm-cream))]">
          <div className="relative min-h-[280px] lg:min-h-[400px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[hsl(var(--rm-navy-dark))]/50 to-transparent lg:hidden" />
          </div>
