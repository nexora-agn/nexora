...
/** Featured quote + supporting cards — not uniform 3-col remodeling grid */
  ...
  return (
    <section className="rm-section-pad bg-white border-t border-border">
      <div className="container-custom container-inset">
        ...
        <article className="border-2 border-[hsl(var(--primary))] bg-[hsl(var(--rm-linen))] p-8 md:p-12 mb-8 relative">
