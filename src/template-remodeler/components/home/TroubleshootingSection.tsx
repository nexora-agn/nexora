...
const remodeling_WARNING_SIGNS = [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed font-sans-brand">
              Small remodeling issues become expensive fast. If you notice any of the symptoms below,
          ...
          <div className="lg:col-span-7">
            <ol className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {remodeling_WARNING_SIGNS.map((sign, index) => (
                <li
                  key={sign}
            ...
            <p className="mt-6 text-xs text-muted-foreground leading-relaxed">
              ...
              utility, then contact a licensed painter for follow-up.
            </p>
          </div>
        </div>
      </div>
