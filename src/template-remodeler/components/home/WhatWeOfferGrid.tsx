...
const WhatWeOfferGrid = () => {
  ...
  return (
    <section className="rm-section-pad bg-[hsl(var(--rm-sage))]/50">
      <div className="container-custom container-inset">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground font-sans-brand max-w-xl mx-auto">
            Home remodels, additions, ADUs, and whole-home remodeling — one accountable team from concept to completion.
          </p>
        </div>
