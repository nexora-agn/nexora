...
/** Editorial portfolio grid on light background — not dark masonry like remodeling */
const SignatureProjectsSection = () => {
  ...
  return (
    <section className="rm-section-pad bg-[hsl(var(--rm-warm-white))]">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          <div>
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-[hsl(var(--primary))] uppercase">
              See Our Home Remodels
            </h2>
            <p className="mt-3 text-muted-foreground font-sans-brand max-w-lg">
              Hunterdon, Somerset, Mercer, and surrounding counties — home remodels, additions, and remodels.
            </p>
          </div>
          <Link
            to="/projects"
