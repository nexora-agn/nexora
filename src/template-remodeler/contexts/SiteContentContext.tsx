...
const STORAGE_KEY = "crestline-site-content-v1";
...
export const SITE_CONTENT_DEFAULTS: SiteContentState = {
  ...
  sectionVisibility: {
    ...
    "home.stats": true,
    "home.process": true,
    "home.videoStory": true,
    "home.reviewPlatforms": true,
    "home.materials": true,
    "home.blogPreview": true,
    "home.finalCta": true,
    "home.whyTeam": false,
    "about.story": true,
    "about.values": true,
      ...
      save({
        ...
        services: [
          ...state.services,
          {
            ...
            image: REMODELER_IMAGES.gardenDesign,
          },
        ],
      }),
      ...
      save({
        ...
        team: [
          ...state.team,
          {
            ...
            image: REMODELER_IMAGES.avatarG,
      ...
      save({
        ...
        projects: [
          ...state.projects,
          {
            ...
            image: REMODELER_IMAGES.gardenDesign,
            gallery: [],
            beforeImage: REMODELER_IMAGES.beforeYard,
            afterImage: REMODELER_IMAGES.afterYard,
