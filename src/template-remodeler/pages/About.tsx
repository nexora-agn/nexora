...
import { ABOUT_HERO_BADGES, REMODELER_IMAGES } from "@template-remodeler/data/siteData";
  ...
  return (
    <Layout>
      ...
      <HarborPageHero
        ...
        eyebrowAfter="Family Owned · Home Remodeling · 25+ Years."
        body={`${COMPANY.name} was built on one belief: your home-building experience should be as exceptional as the finished residence. We're a local home remodeling firm — not a franchise — with vetted architects and craftsmen who treat every project like their own.`}
        image={REMODELER_IMAGES.aboutHero}
        imageAlt="Crestline construction team on site"
        badges={
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 rounded-sm overflow-hidden ring-1 ring-[hsl(var(--border))]">
            <img
              ...
              alt="Crestline crew completing a landscape installation"
