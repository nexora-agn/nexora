  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Meet the home remodeling team and specialists behind ${COMPANY.name} — licensed, local, and committed to quality work across Central NJ.`}
        />
      </Helmet>
      ...
      <section className="bg-[hsl(var(--primary))] text-white py-14 lg:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl leading-tight max-w-2xl">
            Meet the Crestline Team
          </h1>
          <p className="mt-4 text-white/80 max-w-xl leading-relaxed font-sans-brand">
            Production managers, exterior leads, and design liaisons who guide your remodel from free estimate through final walkthrough.
          </p>
        </div>
      </section>

      {sectionVisibility["team.grid"] ? (
        <section className="bg-[hsl(var(--rm-cream))] py-14 lg:py-20">
      ...
      {sectionVisibility["team.cta"] ? (
        <CTASection
          title="Work with our Crestline crew"
          subtitle="Licensed remodeling, ISA-certified arborists, and home remodeling teams across North Jersey."
        />
      ) : null}
    </Layout>
  );
