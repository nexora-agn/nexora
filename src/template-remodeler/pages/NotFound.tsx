...
const QUICK_LINKS: Array<{ label: string; to: string; description: string }> = [
  { label: "Services", to: "/services", description: "Home remodels, additions, ADUs, and whole-home remodeling." },
  { label: "Portfolio", to: "/projects", description: "Recent home remodeling projects across Central New Jersey." },
  { label: "Contact", to: "/contact", description: "Free home remodeling consultations and scheduling." },
];
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`This page could not be found. Return to ${COMPANY.name} for home remodel builders in Central New Jersey.`}
        />
      </Helmet>
          ...
          <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-base md:text-lg text-white/75 leading-relaxed max-w-xl mb-8">
                ...
                Free estimate for remodeling emergencies.
              </p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <Link to="/services/contact" aria-label="Emergency home remodel builder">
