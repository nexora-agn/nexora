...
const Process = () => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Home Remodeling Process | {COMPANY.name}</title>
        <meta
          name="description"
          content={`${COMPANY.name} home remodeling process — consultation, design, permits, construction, and walkthrough for home remodels in Central New Jersey.`}
        />
      </Helmet>
      ...
      <HarborPageHero
        ...
        title="Our Home Remodeling Process"
        ...
        image={REMODELER_IMAGES.processHero}
        imageAlt="Architectural plans and home remodel design"
        dark
      />

      <section className="rm-section-pad section-padding bg-background">
        <div className="container-custom container-inset">
          <div className="max-w-2xl mb-12">
            ...
            <p className="mt-4 text-muted-foreground font-sans-brand leading-relaxed">
              Whether you are starting from scratch, already own land, or are working with an architect, Crestline
      ...
      <CTASection
        title="Ready to start your home remodel?"
