  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`See what Central NJ homeowners and businesses say about ${COMPANY.name} — home remodeling team, quality work, and honest pricing.`}
        />
      </Helmet>
      ...
      <HarborPageHero
        ...
        body="Real feedback from Central New Jersey homeowners and business owners who chose Crestline Home Remodeling for drains, water heaters, emergency repairs, and commercial remodeling work."
        image={REMODELER_IMAGES.reviewsHero}
      ...
      <CTASection
        title="Experience the Crestline difference"
