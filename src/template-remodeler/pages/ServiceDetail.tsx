...
import {
  ...
  REMODELER_IMAGES,
} from "@template-remodeler/data/siteData";
  ...
  return (
    <>
      <HarborPageHero
        ...
        body="When storms bring down limbs or trees threaten your home, you need certified arborists — not untrained crews. Crestline dispatches rigging teams across North Jersey to secure hazards and restore safety."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-white/80 leading-relaxed text-sm">
              Stay clear of downed lines and damaged trees, then call Crestline. We triage urgency and dispatch certified crews — often within 2–4 hours across North Jersey.
            </p>
...
const remodelingInspectionsLayout = () => {
  ...
  return (
    <>
      <HarborPageHero
        ...
        imageAlt="remodeling inspection"
        badges={
          <div className="flex flex-wrap gap-3">
            {[
  ...
  if (!svc) {
    return (
      <HarborPageHero
        ...
        body="That service doesn't exist. Browse our full home remodel home remodeling service catalog."
        image={REMODELER_IMAGES.heroHome}
      />
    );
  }
...
const ServiceDetail = () => {
  ...
  const title = svc ? `${svc.title} | ${COMPANY.name}` : `Home Remodeling Services | ${COMPANY.name}`;
  const desc = svc?.description || `Home remodeling services from ${COMPANY.name} across New Jersey.`;
