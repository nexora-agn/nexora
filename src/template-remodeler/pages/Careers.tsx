...
const OPENINGS: JobOpening[] = [
  {
    id: "lead-carpenter",
    role: "Lead Carpenter — Kitchen & Bath",
    type: "Full-time / field",
    location: "Union, NJ · field",
    level: "5+ yrs",
    summary: "Lead rough and finish carpentry on kitchen and bath remodels — strong layout, tile prep, and client communication.",
  },
  {
    id: "exterior-foreman",
    role: "Exterior Foreman — Roofing & Siding",
    type: "Full-time / field",
    location: "North & Central NJ",
    level: "7+ yrs",
    summary: "Supervise roofing and siding crews, enforce safety, and coordinate material deliveries across Bergen and Morris counties.",
  },
  {
    ...
    location: "Union, NJ",
    level: "3+ yrs",
    summary: "Schedule trades, permit tracking, and homeowner updates for multi-phase remodeling projects.",
  },
  {
    id: "estimator",
    role: "Remodeling Estimator",
    type: "Full-time / hybrid",
    location: "Union, NJ",
    level: "4+ yrs",
    summary: "On-site takeoffs, written scopes, and allowance templates for interior and exterior remodels.",
  },
  {
    id: "apprentice",
    role: "Remodeling Apprentice",
    type: "Apprentice",
    location: "Field, NJ",
    level: "Entry",
    summary: "Two-year mentored program: job site safety, tool skills, and support for licensed lead carpenters.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-base md:text-lg text-white/85 leading-relaxed max-w-md">
              Every Crestline Home Remodeling job site runs under proper safety protocols and code-compliant remodeling. Every employee has stop-work authority. We publish these metrics because insurers and GCs ask for them.
            </p>
          </div>
