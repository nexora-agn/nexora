...
const Blog = () => {
  ...
  const titleBase = `Home Remodeling Blog | ${COMPANY.name}`;
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`home building, safety guides, and Central NJ homeowner advice from the ${COMPANY.name} home remodeling team.`}
        />
      </Helmet>

      <HarborPageHero
        eyebrow="Home Remodeling Blog"
        breadcrumb={[{ label: "Home", to: "/" }, { label: "Blog" }]}
        title="Power Tips & Field Notes"
        body="Honest remodeling advice from licensed home remodeling team — drains, water heaters, surge protection, and safety tips for Central New Jersey homeowners."
        image={REMODELER_IMAGES.blogHero}
        imageAlt="remodeling blog"
      />
              ...
              <aside className="space-y-8 lg:pt-2">
                ...
                <div className="rounded-lg bg-[hsl(var(--primary))] p-6 text-white">
                  ...
                  <p className="text-sm text-white/85 mb-5 leading-relaxed">
                    Free estimates from licensed home remodeling team. Same-day service across Central NJ.
                  </p>
