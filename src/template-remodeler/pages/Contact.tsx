...
import { CONTACT_TRUST_STRIP } from "@template-remodeler/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content={`Contact ${COMPANY.name} for free remodeling estimates and Free estimate emergency service across Central NJ.`} />
      </Helmet>
      ...
      <HarborPageHero
        ...
        image={REMODELER_IMAGES.contactHero}
        imageAlt="Contact Crestline Home Remodeling"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
          ...
          <div className="bg-white text-[hsl(var(--primary))] rounded-lg p-6 lg:p-8 shadow-2xl">
            ...
            <form onSubmit={onSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <textarea
                placeholder="Describe your remodeling issue or project (optional)"
                rows={4}
            ...
            <p className="mt-3 text-[11px] text-slate-500 text-center">
              We respect your privacy. Your information stays with Crestline Home Remodeling.
            </p>
          </div>
        </div>
      </section>
