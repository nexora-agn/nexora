...
import { REMODELER_IMAGES, SERVICE_AREA_COUNTIES } from "@template-remodeler/data/siteData";
import { SEO_CITIES } from "@template-remodeler/data/seoCities";
...
import { SERVICE_AREAS } from "@template-remodeler/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${COMPANY.name} builds luxury home remodels across Hunterdon, Somerset, Mercer, Middlesex, Morris, Union counties in NJ and select Bucks County, PA communities.`}
        />
      </Helmet>
      ...
      <HarborPageHero
        ...
        body="Crestline Home Remodeling serves luxury residential clients across Central New Jersey. Contact us to confirm we build in your municipality."
        image={REMODELER_IMAGES.wholeHomeRemodel}
        imageAlt="Home remodel in Central New Jersey"
        dark={false}
      />

      <section className="rm-section-pad section-padding bg-muted/30">
      ...
      <section className="rm-section-pad section-padding bg-white">
        <div className="container-custom container-inset grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed font-sans-brand">
              Second-generation home remodeling firm serving Central New Jersey since 1999. Our team coordinates
          ...
          <div className="lg:col-span-7 rounded-sm overflow-hidden min-h-[360px] ring-1 ring-border">
            <iframe
              title="Crestline Home Remodeling service area map"
              src={mapEmbedUrl}
      ...
      <CTASection
        ...
        subtitle="Complimentary consultations for home remodels, additions, and remodeling — we respond within one business day."
