...
const TestimonialsSlider = () => {
  ...
  return (
    <section className="industrial-section bg-white">
      <div className="container-custom container-inset max-w-4xl text-center">
        <p className="industrial-eyebrow mb-3">Fleet Client Stories</p>
        <h2 className="industrial-heading mb-12">What Fleet Managers Say</h2>
