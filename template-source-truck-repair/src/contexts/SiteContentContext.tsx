...
import {
  ...
  AWARDS,
  BLOG_POSTS,
} from "@template-truck-repair/data/siteData";
...
const STORAGE_KEY = "truck-repair-site-content-v1";
...
export const SITE_CONTENT_DEFAULTS: SiteContentState = {
  ...
  sectionVisibility: {
    ...
    "home.emergency": true,
    "home.services": true,
    "home.fleetProgram": true,
    "home.whyChoose": true,
    "home.process": true,
    "home.truckTypes": true,
    "home.gallery": true,
    "home.stats": true,
    "home.testimonials": true,
    "home.emergencyCta": true,
    "home.faq": true,
    "home.blog": false,
    "home.reservation": false,
    "home.menuHighlights": false,
    "home.signatureDishes": false,
    "home.chefStory": false,
    "home.experience": false,
    "home.privateEvents": false,
    "home.clientStories": false,
    "home.leadContact": false,
    "home.search": false,
    "home.contactStrip": false,
    "home.promoBanners": false,
    "home.trustBar": false,
    "home.serviceCategories": false,
    "home.residentialCommercial": false,
    "home.treeHighlights": false,
    "home.lawnShowcase": false,
    "home.seasonalServices": false,
    "home.servicesRibbon": false,
    "home.troubleshooting": false,
    "home.whyTeam": false,
    "home.signatureProjects": false,
    "home.emergencyBand": false,
    "home.serviceAreas": false,
    "home.developments": false,
    "home.showcase": false,
    "home.agents": false,
    "home.capabilities": false,
    "about.story": true,
    "about.values": true,
    "about.stats": true,
      ...
      save({
        ...
        services: [
          ...state.services,
          {
            ...
            image: HOME_BUILDER_IMAGES.gardenDesign,
          },
        ],
      }),
      ...
      save({
        ...
        team: [
          ...state.team,
          {
            ...
            image: HOME_BUILDER_IMAGES.avatarG,
      ...
      save({
        ...
        projects: [
          ...state.projects,
          {
            ...
            image: HOME_BUILDER_IMAGES.gardenDesign,
            gallery: [],
            beforeImage: HOME_BUILDER_IMAGES.beforeYard,
            afterImage: HOME_BUILDER_IMAGES.afterYard,
