...
import { HOME_BUILDER_IMAGES, SERVICE_AREA_COUNTIES } from "@template-truck-repair/data/siteData";
import { SEO_CITIES } from "@template-truck-repair/data/seoCities";
...
import { SERVICE_AREAS } from "@template-truck-repair/data/siteData";
