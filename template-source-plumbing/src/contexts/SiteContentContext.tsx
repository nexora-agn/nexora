...
const STORAGE_KEY = "clearcurrent-site-content-v1";
      ...
      save({
        ...
        services: [
          ...state.services,
          {
            ...
            image: "https://images.unsplash.com/photo-1570690732090-275b8807dd76?w=600&h=400&fit=crop",
          },
        ],
      }),
      ...
      save({
        ...
        projects: [
          ...state.projects,
          {
            ...
            image: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&w=600&h=400&q=85",
            gallery: [],
            beforeImage: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&w=600&h=400&q=85",
            afterImage: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=600&h=400&q=85",
