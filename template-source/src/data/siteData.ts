...
export const HOME_HERO = {
  ...
  image:
    "https://images.unsplash.com/photo-1579847188804-ecba0e2ea330?w=1400&h=1750&fit=crop",
...
export const SERVICES = [
  ...
  { id: "renovation", title: "Renovation & Remodeling", icon: "Hammer", description: "Transform existing spaces with expert renovation and remodeling services.", image: "https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=600&h=400&fit=crop" },
  { id: "project-management", title: "Project Management", icon: "ClipboardList", description: "Professional project management ensuring on-time, on-budget delivery.", image: "https://images.unsplash.com/photo-1632862378103-8248dccb7e3d?w=600&h=400&fit=crop" },
  ...
  { id: "interior-design", title: "Interior Design", icon: "Paintbrush", description: "Create stunning interiors that reflect your vision and lifestyle.", image: "https://images.unsplash.com/photo-1558227691-41ea78d1f631?w=600&h=400&fit=crop" },
  { id: "green-building", title: "Green Building", icon: "Leaf", description: "Sustainable construction practices for an eco-friendly future.", image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=600&h=400&fit=crop" },
];

export const PROJECTS = [
  { id: "skyline-tower", title: "Skyline Tower", category: "Commercial", location: "Manhattan, NY", year: "2023", client: "Skyline Development Corp", value: "$45M", description: "A 30-story mixed-use tower featuring state-of-the-art amenities and sustainable design principles.", image: "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=600&h=400&fit=crop", gallery: ["https://images.unsplash.com/photo-1565008576549-57569a49371d?w=800&h=600&fit=crop", "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&h=600&fit=crop"] },
  ...
  { id: "green-office", title: "Green Office Park", category: "Industrial", location: "Jersey City, NJ", year: "2022", client: "EcoSpace Inc", value: "$35M", description: "LEED Platinum certified office campus with renewable energy systems.", image: "https://images.unsplash.com/photo-1518005068251-37900150dfca?w=600&h=400&fit=crop", gallery: [] },
  ...
  { id: "loft-conversion", title: "SoHo Loft Conversion", category: "Residential", location: "Manhattan, NY", year: "2023", client: "Private Client", value: "$4M", description: "Full-floor raw-to-refined conversion with new MEP and bespoke millwork.", image: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&h=400&fit=crop", gallery: [] },
  { id: "data-center-edge", title: "Edge Data Hall", category: "Industrial", location: "Ashburn, VA", year: "2024", client: "CloudScale Inc", value: "$62M", description: "Tier III hall with redundant cooling, commissioning, and LEED-ready envelope.", image: "https://images.unsplash.com/photo-1541976590-713941681591?w=600&h=400&fit=crop", gallery: [] },
];
...
export const TEAM = [
  ...
  { id: "emily-watson", name: "Emily Watson", role: "Head of Design", bio: "Creative interior designer transforming spaces into experiences.", image: "https://images.unsplash.com/photo-1760161306014-e2dcc13cbdf8?w=300&h=300&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "david-park", name: "David Park", role: "Chief Engineer", bio: "Structural engineering expert with 20+ years of experience.", image: "https://images.unsplash.com/photo-1626885930974-4b69aa21bbf9?w=300&h=300&fit=crop", social: { linkedin: "#", twitter: "#" } },
  { id: "lisa-thompson", name: "Lisa Thompson", role: "Operations Manager", bio: "Streamlines operations for maximum efficiency and quality.", image: "https://images.unsplash.com/photo-1657728468454-3665e9bfe4be?w=300&h=300&fit=crop", social: { linkedin: "#", twitter: "#" } },
];
...
export const SERVICE_DEEP_DIVES: {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1621905251918-48416bd8575a?w=900&h=700&fit=crop",
    inclusions: [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=900&h=700&fit=crop",
    inclusions: [
      "Test-fit & pricing",
