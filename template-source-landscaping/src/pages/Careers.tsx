  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Join ${COMPANY.name}: journeyman plumbers, EV specialists, commercial plumbers, and apprentices across DFW.`}
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <p className="mt-6 max-w-xl text-base md:text-lg text-white/85 leading-relaxed">
              Long tenure, written offers, and published pay bands for every role. We&apos;d rather find one plumber we&apos;ll keep than fill a slot every six months.
            </p>
          </div>
