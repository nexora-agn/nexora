...
const TREE_SERVICES = [
  { id: "tree-removal", title: "Tree Removal", image: LANDSCAPING_IMAGES.treeRemoval },
  { id: "tree-trimming", title: "Trimming & Pruning", image: LANDSCAPING_IMAGES.treeTrimming },
  { id: "stump-grinding", title: "Stump Grinding", image: LANDSCAPING_IMAGES.stumpGrinding },
  { id: "emergency-tree-service", title: "24/7 Emergency", image: LANDSCAPING_IMAGES.emergencyTree },
] as const;
