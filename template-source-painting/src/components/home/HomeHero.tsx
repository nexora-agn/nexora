...
const HomeHero = () => {
  ...
  const heroImage =
    HOME_HERO.image ||
    resolveServiceImage("emergency-plumbing", PAINTING_IMAGES.heroPlumber);
    ...
    <section className="relative overflow-hidden bg-[hsl(var(--primary))]">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[520px] lg:min-h-[580px]">
        ...
        <div className="relative z-10 flex flex-col justify-center py-12 lg:py-16 text-white">
          <div
            aria-hidden
            className="absolute inset-0 bg-[hsl(var(--primary))] lg:bg-gradient-to-br from-[hsl(var(--primary))] via-[hsl(var(--primary))] to-[hsl(var(--flow-dark-panel))]"
          />
          <div className="relative w-full px-4 sm:px-6 lg:pl-[max(1.5rem,calc((100vw-80rem)/2+1.5rem))] lg:pr-10 xl:pr-14">
            ...
            >
              <span className="flex h-14 w-14 items-center justify-center rounded-full bg-[hsl(var(--secondary))] text-[hsl(var(--secondary-foreground))] flow-glow shrink-0">
        ...
        <motion className="relative min-h-[280px] sm:min-h-[360px] lg:min-h-full">
          <img
            src={heroImage}
            alt=""
            aria-hidden
            className="absolute inset-0 h-full w-full object-cover flow-clip-diagonal"
          />
          <div
            aria-hidden
            className="absolute inset-0 bg-gradient-to-t from-[hsl(var(--primary))]/80 via-transparent to-transparent lg:bg-gradient-to-l from-transparent via-[hsl(var(--primary))]/20 to-[hsl(var(--primary))]/70 flow-clip-diagonal"
          />
