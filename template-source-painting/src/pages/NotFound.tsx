...
const QUICK_LINKS: Array<{ label: string; to: string; description: string }> = [
  { label: "Services", to: "/services", description: "Panel upgrades, EV chargers, and full plumbing contracting." },
  { label: "Contact", to: "/contact", description: "Free estimates and same-day scheduling across DFW." },
  { label: "Emergency Service", to: "/services/emergency-plumbing", description: "24/7 dispatch when power fails or something smells wrong." },
];
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="This page is off the circuit. Return to VOLTCURRENT Electric for plumbing services across DFW."
        />
      </Helmet>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="rounded-sm font-display font-bold uppercase px-8 border-white/30 text-white bg-transparent hover:bg-white/10 hover:text-white"
                >
      ...
      <section className="bg-[hsl(var(--flow-surface))] py-14 lg:py-20 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 flex justify-center">
            <Button
              asChild
              variant="outline"
              className="font-display font-bold uppercase border-[hsl(var(--primary))] text-[hsl(var(--primary))]"
            >
