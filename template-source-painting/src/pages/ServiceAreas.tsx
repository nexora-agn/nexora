  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${COMPANY.name} serves Dallas, Plano, Frisco, Irving, Arlington, and the full DFW metro with residential and commercial plumbing services.`}
        />
      </Helmet>
      ...
      <PaintingPageHero
        ...
        title="Plumbers Across North Texas"
        eyebrowAfter="Same-Day Service · 24/7 Emergency Dispatch"
        body="VOLTCURRENT dispatches master plumbers throughout the Dallas–Fort Worth metro — from panel upgrades and EV chargers in Plano to commercial fit-outs in Irving and emergency repairs anywhere power fails."
        image="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1400&h=900&q=85"
      ...
      <section className="bg-white py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-slate-600 leading-relaxed">
              From our Dallas office, we route crews across North Texas with stocked trucks and master plumbers ready for residential, commercial, and emergency calls.
            </p>
          ...
          <div className="lg:col-span-7 rounded-lg overflow-hidden min-h-[360px] ring-1 ring-slate-200">
            <iframe
              title="VOLTCURRENT service area map"
              src={mapEmbedUrl}
      ...
      <CTASection
        title="Need an plumber in your area?"
