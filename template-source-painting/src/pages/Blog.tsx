  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Plumbing tips, safety guides, and DFW homeowner advice from the ${COMPANY.name} master plumbers.`}
        />
      </Helmet>
      ...
      <PaintingPageHero
        ...
        body="Honest plumbing advice from licensed master plumbers — panel upgrades, EV chargers, surge protection, and safety tips for Dallas–Fort Worth homeowners."
        image="https://images.unsplash.com/photo-1570690732090-275b8807dd76?auto=format&fit=crop&w=1400&h=900&q=85"
              ...
              <aside className="space-y-8 lg:pt-2">
                ...
                <div className="rounded-lg bg-[hsl(var(--primary))] p-6 text-white">
                  ...
                  <p className="text-sm text-white/85 mb-5 leading-relaxed">
                    Free estimates from licensed master plumbers. Same-day service across DFW.
                  </p>
