...
import { PAINTING_IMAGES } from "@/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content={`Contact ${COMPANY.name} for free plumbing estimates and 24/7 emergency service across DFW.`} />
      </Helmet>
      ...
      <PaintingPageHero
        ...
        body="Free estimates, same-day service, and 24/7 emergency dispatch — reach out and a licensed master plumber will respond fast."
        image={PAINTING_IMAGES.contactHero}
