...
import PaintingPageHero from "@/components/sections/PaintingPageHero";
  ...
  return (
    <>
      <PaintingPageHero
        ...
        body="When the power's out or something smells wrong, you need a licensed master — not a handyman with a voltage tester. VOLTCURRENT rolls stocked trucks across DFW to isolate faults, make safe repairs, and restore power."
        image="https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&w=1400&h=900&q=85"
        ...
        badges={
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span key={id} className="inline-flex items-center gap-2 rounded-sm bg-white/10 px-3 py-2 text-xs font-display font-bold uppercase tracking-wider">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-white/80 leading-relaxed text-sm">
              Stay safe, shut off power if you can, and call VOLTCURRENT. We&apos;ll triage urgency and dispatch a master plumber — usually within 2–4 hours across DFW.
            </p>
          ...
          <div className="hidden lg:block lg:col-span-3">
            <img
              src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=600&h=600&q=85"
      ...
      <section className="bg-[hsl(var(--flow-surface))] py-14 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative rounded-lg overflow-hidden min-h-[280px]">
            <img
              src={PAINTING_IMAGES.smartHome.replace("w=600", "w=900").replace("h=400", "h=700")}
  ...
  return (
    <>
      ...
      <CTASection
        ...
        subtitle="Free estimates from licensed master plumbers. Same-day service available across DFW."
      />
      <LeadContactSection />
    </>
  );
...
const ServiceDetail = () => {
  ...
  const desc = svc?.description || `Plumbing services from ${COMPANY.name} across Dallas–Fort Worth.`;
