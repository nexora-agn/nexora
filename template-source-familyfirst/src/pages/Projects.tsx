...
import { PROJECTS_LATEST_PAGE_SIZE } from "@/data/siteData";
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Plumbing projects completed by ${COMPANY.name} — panel upgrades, EV chargers, commercial fit-outs, and more across DFW.`}
        />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <p className="mt-4 text-white/80 max-w-xl leading-relaxed">
              Panel upgrades, EV chargers, whole-home rewires, and commercial fit-outs — NEC-compliant installs with master plumber oversight from start to finish.
            </p>
          </div>
