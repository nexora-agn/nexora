...
import { HOME_BUILDER_IMAGES, SERVICE_AREA_COUNTIES } from "@template-homebuilder/data/siteData";
import { SEO_CITIES } from "@template-homebuilder/data/seoCities";
...
import { SERVICE_AREAS } from "@template-homebuilder/data/siteData";
