            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {areas.map(area => (
                <Link
                  key={area}
                  to="/service-areas"
                  className="inline-flex items-center rounded-full border border-[hsl(var(--border))] bg-[hsl(var(--volt-surface))] px-4 py-2 text-sm font-medium text-[hsl(var(--primary))] hover:border-[hsl(var(--secondary))] hover:bg-[hsl(var(--secondary))]/10 hover:text-[hsl(var(--primary))] transition-colors"
                >
                  {area}
                </Link>
              ))}
