...
const STEPS = [
  ...
  },
  {
    icon: Phone,
    label: "Phone screen",
    body: "Twenty minutes with operations or a lead electrician. Two-way conversation, not an interrogation.",
  },
  {
    icon: HardHat,
    label: "Ride-along",
  ...
  },
  {
    ...
    perks: [
      ...
      },
      {
        ...
        body: "Up to $4,000/year for licensure, CE credits, or master electrician prep.",
      },
      {
        icon: Award,
    ...
    perks: [
      {
        ...
        body: "Paired with a master electrician for a documented two-year safety + install curriculum.",
      },
      {
        icon: CalendarRange,
...
const OPENINGS: JobOpening[] = [
  {
    ...
    role: "Journeyman Electrician — Residential",
    type: "Full-time / field",
    location: "DFW dispatch",
    level: "3–7 yrs",
    summary:
      "Panel upgrades, rewires, EV chargers, and service calls — NEC-compliant work with clean job sites and labeled panels.",
  },
  {
    id: "ev-specialist",
  ...
  },
  {
    ...
    type: "Full-time / field",
    location: "DFW commercial routes",
    level: "5+ yrs",
    summary:
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Join ${COMPANY.name}: journeyman electricians, EV specialists, commercial electricians, and apprentices across DFW.`}
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <p className="mt-6 max-w-xl text-base md:text-lg text-white/85 leading-relaxed">
              Long tenure, written offers, and published pay bands for every role. We&apos;d rather find one electrician we&apos;ll keep than fill a slot every six months.
            </p>
          </div>
      ...
      <section className="bg-[hsl(var(--volt-surface))] py-14 lg:py-20 border-b border-slate-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {activeTab.perks.map(({ icon: Icon, title, body }) => (
              <article
                key={title}
                className="rounded-lg bg-[hsl(var(--volt-surface))] border border-slate-100 p-6 hover:border-[hsl(var(--secondary))]/50 hover:-translate-y-0.5 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-base md:text-lg text-white/85 leading-relaxed max-w-md">
              Every VOLTCURRENT job site runs under lockout/tagout, arc-flash awareness, and NEC compliance. Every employee has stop-work authority. We publish these metrics because insurers and GCs ask for them.
            </p>
          </div>
            ...
            {OPENINGS.map(role => (
              <li key={role.id}>
                <a
                  ...
                  className="group grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 px-5 md:px-7 py-5 hover:bg-[hsl(var(--volt-surface))] transition-colors items-center"
                >
