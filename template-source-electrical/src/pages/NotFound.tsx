  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="This page is off the circuit. Return to VOLTCURRENT Electric for electrical services across DFW."
        />
      </Helmet>
      ...
      <section className="bg-[hsl(var(--volt-surface))] py-14 lg:py-20 border-t border-slate-200">
