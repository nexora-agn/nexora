...
/** Unique electrician/trade Unsplash photos — each used only once in default content. */
const u = (id: string, w = 600, h = 400) =>
  `https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=${w}&h=${h}&q=85`;

/** Electrician-only Unsplash photos — do not reuse Roofix / roofing template IDs. */
export const ELECTRICAL_IMAGES = {
  heroElectrician: u("1621905252507-b35492cc74b4", 1920, 1080),
  workerElectrician: u("1621905251189-08b45d6a269e"),
  workerElectrician2: u("1621905251918-48416bd8575a"),
  ...
  commercialElectrical: u("1600880292089-90a7e086ee0c"),
...
export const COMPANY = {
  ...
  tagline:
    "Premium electrical contracting for Dallas–Fort Worth homes and businesses — master electricians, code-perfect work, and power you can count on.",
  phone: "(214) 555-0142",
  email: "service@voltcurrentelectric.com",
...
export const SITE_TOP = {
  line: "24/7 Emergency Electrical Service",
  badges: ["Licensed & Insured", "Master Electricians", "Same-Day Service"],
  ratingValue: "4.9",
  ratingCount: "320+",
  ratingLabel: "Reviews",
...
/** Homepage hero — split layout with emergency CTA and electrician photography. */
export const HOME_HERO = {
  ...
  body:
    "From panel upgrades and EV chargers to emergency repairs and commercial fit-outs, VOLTCURRENT delivers charcoal-sharp craftsmanship, upfront pricing, and electricians who treat your property like their own.",
  primaryCta: { label: "24/7 EMERGENCY SERVICE", to: "/services/emergency-electrical" },
  secondaryCta: { label: "CALL NOW", to: "/contact" },
  image: ELECTRICAL_IMAGES.heroElectrician,
  trustPills: [
    { label: "Licensed & Insured", sub: "Texas Master Electricians", icon: "ShieldCheck" as const },
  ...
  featuredTitle: "Premium Electrical Contractor",
...
export const SERVICES_RIBBON = [
  ...
  },
  {
    ...
    to: "/services/residential-electrical",
  },
  {
    id: "ev-charger",
    label: "EV CHARGERS",
  ...
  },
  {
    ...
    description: "Tenant improvements, retail, and industrial electrical built for uptime.",
    to: "/services/commercial-electrical",
  },
];
...
export const PROCESS_STEPS = [
  ...
  { id: "diagnose", label: "On-Site Diagnosis", description: "A master electrician tests, photos, and explains options in plain English." },
...
export const SERVICES = [
  ...
  },
  {
    ...
    image: ELECTRICAL_IMAGES.panelUpgrade,
  },
  {
    id: "residential-electrical",
    ...
    image: ELECTRICAL_IMAGES.workerElectrician,
  },
  {
    id: "ev-charger",
    ...
    image: ELECTRICAL_IMAGES.evCharger,
  },
  {
    id: "commercial-electrical",
    title: "Commercial Electrical",
    icon: "Hammer",
    description: "Tenant improvements, retail, office, and industrial electrical built for uptime.",
    image: ELECTRICAL_IMAGES.commercialElectrical,
  },
];
...
export const BEFORE_AFTER_PROJECTS = [
  {
    ...
    beforeImage: ELECTRICAL_IMAGES.oldWiring,
    afterImage: ELECTRICAL_IMAGES.panelUpgrade,
  },
  {
    id: "plano-ev-charger",
    ...
    beforeImage: ELECTRICAL_IMAGES.evGarage,
    afterImage: ELECTRICAL_IMAGES.evCharger,
  },
  {
    ...
    serviceId: "residential-electrical",
    beforeImage: ELECTRICAL_IMAGES.oldWiring,
    afterImage: ELECTRICAL_IMAGES.workerElectrician,
  },
  {
    ...
    beforeImage: ELECTRICAL_IMAGES.commercialSplit,
    afterImage: ELECTRICAL_IMAGES.commercialElectrical,
  },
  {
    ...
    category: "Emergency",
    serviceId: "emergency-electrical",
    beforeImage: ELECTRICAL_IMAGES.emergencyScene,
    afterImage: ELECTRICAL_IMAGES.workerElectrician2,
  },
];
...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    role: "Plano, TX",
    quote:
      "Power went out at 11 PM — they had a master electrician at our door in under two hours. Lifesavers.",
...
export const BLOG_POSTS = [
  {
    id: "when-to-upgrade-electrical-panel",
    title: "When to Upgrade Your Electrical Panel in Texas",
    ...
    image: ELECTRICAL_IMAGES.panelUpgrade,
    content:
      "Flickering lights when the AC kicks on, warm breakers, or a panel full of tandem breakers are red flags. In DFW's heat, modern homes need headroom for EV chargers, pool equipment, and smart loads. A licensed master electrician can load-calc your home and recommend a 200-amp upgrade with AFCI protection — usually completed in one day with city inspection included.",
  },
  {
    ...
    author: "Priya Nair",
    category: "EV Charging",
    image: ELECTRICAL_IMAGES.evGarage,
    content:
  ...
  },
  {
    ...
    category: "Safety",
    image: ELECTRICAL_IMAGES.surgeProtection,
    content:
  ...
  },
  {
    ...
    author: "Marcus Reed",
    category: "Safety",
    image: ELECTRICAL_IMAGES.oldWiring,
    content:
  ...
  },
  {
    ...
    image: ELECTRICAL_IMAGES.backupPower,
    content:
  ...
  },
  {
    ...
    author: "Priya Nair",
    category: "Smart Home",
    image: ELECTRICAL_IMAGES.smartHome,
    content:
...
export const FAQ_ITEMS = [
  {
    ...
    answer:
      "We offer 24/7 emergency dispatch across the Dallas metro. Most urgent calls receive a master electrician within 2–4 hours, depending on location and storm volume.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. VOLTCURRENT holds a Texas electrical contractor license, full general liability, and workers' compensation. Certificates available on request before work begins.",
  },
  {
...
export const NAV_LINKS = [
  ...
  { label: "Emergency Service", path: "/services/emergency-electrical" },
...
export const FOOTER_SERVICE_LINKS: { label: string; to: string }[] = [
  { label: "Emergency Service", to: "/services/emergency-electrical" },
  { label: "Panel Upgrades", to: "/services/panel-upgrades" },
  { label: "Residential Electrical", to: "/services/residential-electrical" },
  { label: "EV Charger Installation", to: "/services/ev-charger" },
  { label: "Commercial Electrical", to: "/services/commercial-electrical" },
];
...
export const CERTIFICATIONS = [
  { id: "texas-master", label: "Texas Master Electrician", sub: "State-licensed contracting" },
  { id: "nec", label: "NEC Compliant", sub: "2023 National Electrical Code" },
...
export const FAQ_BY_CATEGORY: Record<FaqTabId, { question: string; answer: string }[]> = {
  ...
  emergency: [
    ...
    },
    {
      ...
      answer:
        "Most DFW emergency calls receive a master electrician within 2–4 hours, 24/7/365. During major storms, we prioritize life-safety issues first.",
    },
    {
...
export const SERVICES_PAGE_INTRO =
  "Five core electrical services for Dallas–Fort Worth — 24/7 emergency response, panel upgrades, residential wiring, EV charger installs, and commercial fit-outs. Master electricians, code-perfect work, upfront pricing.";
...
export const SERVICE_DEEP_DIVES: {
...
}[] = [
  {
    ...
    image: ELECTRICAL_IMAGES.emergencyScene,
    inclusions: [
      "24/7 phone dispatch",
...
export const LEAD_FORM = {
  title: "Get Your Free Electrical Estimate",
  description: "No obligation. Master electrician review within one business day.",
  bullets: [
    "Free on-site or virtual estimate",
    "Upfront, honest pricing",
    "Same-day service available",
    "Licensed Texas master electricians",
  ],
};
...
export const STORM_CHECKLIST = [
  ...
  { id: "call", title: "Call VOLTCURRENT Electric", description: "24/7 dispatch — we'll triage urgency and send a master electrician." },
...
/** Electrical inspections page — benefits cards. */
...
/** Electrical inspections page — types of inspection cards. */
...
export const CONTACT_TRUST_STRIP = [
  { id: "licensed", title: "Licensed & Insured", description: "Texas master electricians with full liability coverage.", icon: "ShieldCheck" as const },
  ...
  { id: "expert", title: "Master Electricians", description: "Experienced crews — not handymen with extension cords.", icon: "Users" as const },
...
export const ABOUT_HERO_BADGES = [
  ...
  { id: "licensed", title: "Licensed Master Electricians", icon: "ShieldCheck" as const },
